...
import type1data from '../../../../../listData/dataExercise/A1/Sentence/Type1';
import type3data from '../../../../../listData/dataExercise/A1/Sentence/Type3';
import type5data from '../../../../../listData/dataExercise/A1/Sentence/Type5';
import type8data from '../../../../../listData/dataExercise/A1/Sentence/Type8';
...
let option1 = [type8data, type1data, type3data, type5data, type8data];
let option2 = [type8data, type5data, type3data, type1data, type8data];

const links1 = ['Exc1x5x1', 'Type1', 'Type3', 'Type5', 'Type8'];
const links2 = ['Exc1x5x1', 'Type5', 'Type3', 'Type1', 'Type8'];
...
const Exc1x5x1 = ({ route }) => {
    ...
    useEffect(() => {
      ...
      let type1dataNew = Object.keys(route.params.data).length === 0 ? type1data : parsedData.sentence.type1;
      let type3dataNew = Object.keys(route.params.data).length === 0 ? type3data : parsedData.sentence.type3;
      let type5dataNew = Object.keys(route.params.data).length === 0 ? type5data : parsedData.sentence.type5;
      let type8dataNew = Object.keys(route.params.data).length === 0 ? type8data : parsedData.sentence.type8;

      option1 = [type8dataNew, type1dataNew, type3dataNew, type5dataNew, type8dataNew];
      option2 = [type8dataNew, type5dataNew, type3dataNew, type1dataNew, type8dataNew];
