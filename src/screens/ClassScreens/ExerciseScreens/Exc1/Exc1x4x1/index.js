...
import type1data from '../../../../../listData/dataExercise/A1/Pronouns/Type1';
import type3data from '../../../../../listData/dataExercise/A1/Pronouns/Type3';
import type4data from '../../../../../listData/dataExercise/A1/Pronouns/Type4';
import type6data from '../../../../../listData/dataExercise/A1/Pronouns/Type6';


const dataForMarkers = {
  part: 'exercise',
  section: 'section1', // change section 
  class: 'class3' // change class
}

let option1 = [type1data, type3data, type4data, type6data, type1data]; 
let option2 = [type1data, type6data, type4data, type3data, type1data]; 

const links1 = ['Exc1x4x1', 'Type3', 'Type4', 'Type6', 'Type1']; 
const links2 = ['Exc1x4x1', 'Type6', 'Type4', 'Type3', 'Type1']; 
...
const Exc1x4x1 = ({route}) => {
  ...
  useEffect(() => {
    ...
    let type1dataNew = Object.keys(route.params.data).length === 0 ? type1data : parsedData.pronouns.type1;
    let type3dataNew = Object.keys(route.params.data).length === 0 ? type3data : parsedData.pronouns.type3;
    let type4dataNew = Object.keys(route.params.data).length === 0 ? type4data : parsedData.pronouns.type4;
    let type6dataNew = Object.keys(route.params.data).length === 0 ? type6data : parsedData.pronouns.type6;

    // update options array with new parsed data from firebase if firebase connection === true

    option1 = [type1dataNew, type3dataNew, type4dataNew, type6dataNew, type1dataNew];
    option2 = [type1dataNew, type6dataNew, type4dataNew, type3dataNew, type1dataNew];
...
export default Exc1x4x1  // change name here
