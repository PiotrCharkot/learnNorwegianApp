...
import type1data from '../../../../../listData/dataExercise/A1/Adverbs/Type1';
import type2data from '../../../../../listData/dataExercise/A1/Adverbs/Type2';
import type3data from '../../../../../listData/dataExercise/A1/Adverbs/Type3';
import type4data from '../../../../../listData/dataExercise/A1/Adverbs/Type4';
import type5data from '../../../../../listData/dataExercise/A1/Adverbs/Type5';
import type6data from '../../../../../listData/dataExercise/A1/Adverbs/Type6';
import type7data from '../../../../../listData/dataExercise/A1/Adverbs/Type7';
...
let option1 = [type3data, type1data, type4data, type2data, type7data];
let option2 = [type3data, type5data, type6data, type4data, type1data];
let option3 = [type3data, type4data, type5data, type7data, type6data];

const links1 = ['Exc1x3x1', 'Type1', 'Type4', 'Type2', 'Type7'];
const links2 = ['Exc1x3x1', 'Type5', 'Type6', 'Type4', 'Type1'];
const links3 = ['Exc1x3x1', 'Type4', 'Type5', 'Type7', 'Type6'];
...
const Exc1x3x1 = ({ route }) => {
    ...
    useEffect(() => {
      ...
      option1 = [type3dataNew, type1dataNew, type4dataNew, type2dataNew, type7dataNew];
      option2 = [type3dataNew, type5dataNew, type6dataNew, type4dataNew, type1dataNew];
      option3 = [type3dataNew, type4dataNew, type5dataNew, type7dataNew, type6dataNew];
