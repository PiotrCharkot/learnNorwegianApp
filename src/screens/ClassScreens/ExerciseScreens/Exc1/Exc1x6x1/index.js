...
import type1data from '../../../../../listData/dataExercise/A1/All/Type1';
import type2data from '../../../../../listData/dataExercise/A1/All/Type2';
import type3data from '../../../../../listData/dataExercise/A1/All/Type3';
import type4data from '../../../../../listData/dataExercise/A1/All/Type4';
import type5data from '../../../../../listData/dataExercise/A1/All/Type5';
import type6data from '../../../../../listData/dataExercise/A1/All/Type6';
import type7data from '../../../../../listData/dataExercise/A1/All/Type7';
import type8data from '../../../../../listData/dataExercise/A1/All/Type8';
...
let option1 = [type5data, type1data, type2data, type3data, type4data, type7data];
let option2 = [type5data, type8data, type6data, type4data, type1data];
let option3 = [type5data, type3data, type7data, type1data, type4data];

const links1 = ['Exc1x6x1', 'Type1', 'Type2', 'Type3', 'Type4', 'Type7'];
const links2 = ['Exc1x6x1', 'Type8', 'Type6', 'Type4', 'Type1'];
const links3 = ['Exc1x6x1', 'Type3', 'Type7', 'Type1', 'Type4'];
...
const Exc1x6x1 = ({route}) => {
    ...
    useEffect(() => {
      ...
      option1 = [type5dataNew, type1dataNew, type2dataNew, type3dataNew, type4dataNew, type7dataNew];
      option2 = [type5dataNew, type8dataNew, type6dataNew, type4dataNew, type1dataNew];
      option3 = [type5dataNew, type3dataNew, type7dataNew, type1dataNew, type4dataNew];
