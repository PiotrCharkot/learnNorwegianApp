...
import type7data from '../../../../../listData/dataExercise/B1/Agreement/Type7';
...
let option1 = [type4data, type1data, type5data, type7data, type4data];
let option2 = [type4data, type7data, type5data, type4data, type1data];
let option3 = [type4data, type5data, type7data, type1data];

const links1 = ['Exc3x5x1', 'Type1', 'Type5', 'Type7', 'Type4'];
const links2 = ['Exc3x5x1', 'Type7', 'Type5', 'Type4', 'Type1'];
const links3 = ['Exc3x5x1', 'Type5', 'Type7', 'Type1'];
...
const Exc3x5x1 = ({route}) => {
    ...
    useEffect(() => {
      ...
      let type1dataNew = Object.keys(route.params.data).length === 0 ? type1data : parsedData.agreement.type1
      let type4dataNew = Object.keys(route.params.data).length === 0 ? type4data : parsedData.agreement.type4
      let type5dataNew = Object.keys(route.params.data).length === 0 ? type5data : parsedData.agreement.type5
      let type7dataNew = Object.keys(route.params.data).length === 0 ? type7data : parsedData.agreement.type7

      option1 = [type4dataNew, type1dataNew, type5dataNew, type7dataNew, type4dataNew];
      option2 = [type4dataNew, type7dataNew, type5dataNew, type4dataNew, type1dataNew];
      option3 = [type4dataNew, type5dataNew, type7dataNew, type1dataNew];
