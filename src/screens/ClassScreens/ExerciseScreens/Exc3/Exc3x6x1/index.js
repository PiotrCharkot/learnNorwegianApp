...
import type5data from '../../../../../listData/dataExercise/B1/All/Type5';
import type6data from '../../../../../listData/dataExercise/B1/All/Type6';
import type7data from '../../../../../listData/dataExercise/B1/All/Type7';
import type8data from '../../../../../listData/dataExercise/B1/All/Type8';
...
let option1 = [type5data, type8data, type3data, type4data, type6data, type1data];
let option2 = [type5data, type3data, type1data, type8data, type7data];
let option3 = [type5data, type7data, type4data, type1data, type3data];

const links1 = ['Exc3x6x1', 'Type8', 'Type3', 'Type4', 'Type6', 'Type1'];
const links2 = ['Exc3x6x1', 'Type3', 'Type1', 'Type8', 'Type7'];
...
const Exc3x6x1 = ({route}) => {
    ...
    useEffect(() => {
      ...
      option1 = [type5dataNew, type8dataNew, type3dataNew, type4dataNew, type6dataNew, type1dataNew];
      option2 = [type5dataNew, type3dataNew, type1dataNew, type8dataNew, type7dataNew];
