...
import type1data from '../../../../../listData/dataExercise/B1/Perfect/Type1'
import type3data from '../../../../../listData/dataExercise/B1/Perfect/Type3'
import type4data from '../../../../../listData/dataExercise/B1/Perfect/Type4'
import type5data from '../../../../../listData/dataExercise/B1/Perfect/Type5'
import type8data from '../../../../../listData/dataExercise/B1/Perfect/Type8'
...
let option1 = [type8data, type1data, type3data, type4data, type5data];
let option2 = [type8data, type4data, type1data, type5data, type3data];
let option3 = [type8data, type5data, type3data, type1data, type8data];

const links1 = ['Exc3x3x1', 'Type1', 'Type3', 'Type4', 'Type5'];
const links2 = ['Exc3x3x1', 'Type4', 'Type1', 'Type5', 'Type3'];
const links3 = ['Exc3x3x1', 'Type5', 'Type3', 'Type1', 'Type8' ];
...
const Exc3x3x1 = ({ route }) => {
    ...
    useEffect(() => {
      ...
      let type1dataNew = Object.keys(route.params.data).length === 0 ? type1data : parsedData.perfectTense.type1
      let type3dataNew = Object.keys(route.params.data).length === 0 ? type3data : parsedData.perfectTense.type3
      let type4dataNew = Object.keys(route.params.data).length === 0 ? type4data : parsedData.perfectTense.type4
      let type5dataNew = Object.keys(route.params.data).length === 0 ? type5data : parsedData.perfectTense.type5
      let type8dataNew = Object.keys(route.params.data).length === 0 ? type8data : parsedData.perfectTense.type8

      option1 = [type8dataNew, type1dataNew, type3dataNew, type4dataNew, type5dataNew];
      option2 = [type8dataNew, type4dataNew, type1dataNew, type5dataNew, type3dataNew];
      option3 = [type8dataNew, type5dataNew, type3dataNew, type1dataNew, type8dataNew];
