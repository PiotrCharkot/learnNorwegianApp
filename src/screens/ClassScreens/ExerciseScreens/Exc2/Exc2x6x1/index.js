...
import type1data from '../../../../../listData/dataExercise/A2/All/Type1'
import type2data from '../../../../../listData/dataExercise/A2/All/Type2'
import type3data from '../../../../../listData/dataExercise/A2/All/Type3'
import type4data from '../../../../../listData/dataExercise/A2/All/Type4'
import type5data from '../../../../../listData/dataExercise/A2/All/Type5'
import type6data from '../../../../../listData/dataExercise/A2/All/Type6'
import type7data from '../../../../../listData/dataExercise/A2/All/Type7'
import type8data from '../../../../../listData/dataExercise/A2/All/Type8'
...
let option1 = [type5data, type2data, type3data, type4data, type8data, type6data];
let option2 = [type5data, type1data, type8data, type2data, type3data, type4data];
let option3 = [type5data, type4data, type1data, type8data, type2data];

const links1 = ['Exc2x6x1', 'Type2', 'Type3', 'Type4', 'Type8', 'Type6'];
const links2 = ['Exc2x6x1', 'Type1', 'Type8', 'Type2', 'Type3', 'Type4'];
const links3 = ['Exc2x6x1', 'Type4', 'Type1', 'Type8', 'Type2'];
...
const Exc2x6x1 = ({route}) => {
    ...
    useEffect(() => {
      ...
      option1 = [type5dataNew, type2dataNew, type3dataNew, type4dataNew, type8dataNew, type6dataNew];
      option2 = [type5dataNew, type1dataNew, type8dataNew, type2dataNew, type3dataNew, type4dataNew];
      option3 = [type5dataNew, type4dataNew, type1dataNew, type8dataNew, type2dataNew];
