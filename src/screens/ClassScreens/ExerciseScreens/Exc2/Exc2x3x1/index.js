...
import type3data from '../../../../../listData/dataExercise/A2/Modal/Type3'
import type4data from '../../../../../listData/dataExercise/A2/Modal/Type4'
import type5data from '../../../../../listData/dataExercise/A2/Modal/Type5'
import type7data from '../../../../../listData/dataExercise/A2/Modal/Type7'
import type8data from '../../../../../listData/dataExercise/A2/Modal/Type8'
...
let option1 = [type3data, type4data, type5data, type7data, type8data];
let option2 = [type3data, type7data, type8data, type4data, type5data];
let option3 = [type3data, type8data, type5data, type4data, type7data];

const links1 = ['Exc2x3x1', 'Type4', 'Type5', 'Type7', 'Type8'];
const links2 = ['Exc2x3x1', 'Type7', 'Type8', 'Type4', 'Type5'];
const links3 = ['Exc2x3x1', 'Type8', 'Type5', 'Type4', 'Type7'];
...
const Exc2x3x1 = ({ route }) => {
    ...
    useEffect(() => {
      ...
      let type3dataNew = Object.keys(route.params.data).length === 0 ? type3data : parsedData.modal.type3;
      let type4dataNew = Object.keys(route.params.data).length === 0 ? type4data : parsedData.modal.type4;
      let type5dataNew = Object.keys(route.params.data).length === 0 ? type5data : parsedData.modal.type5;
      let type7dataNew = Object.keys(route.params.data).length === 0 ? type7data : parsedData.modal.type7;
      let type8dataNew = Object.keys(route.params.data).length === 0 ? type8data : parsedData.modal.type8;

      option1 = [type3dataNew, type4dataNew, type5dataNew, type7dataNew, type8dataNew];
      option2 = [type3dataNew, type7dataNew, type8dataNew, type4dataNew, type5dataNew];
      option3 = [type3dataNew, type8dataNew, type5dataNew, type4dataNew, type7dataNew];
