...
import type1data from '../../../../../listData/dataExercise/A2/Adverbs/Type1';
import type2data from '../../../../../listData/dataExercise/A2/Adverbs/Type2';
import type3data from '../../../../../listData/dataExercise/A2/Adverbs/Type3';
import type4data from '../../../../../listData/dataExercise/A2/Adverbs/Type4';
import type5data from '../../../../../listData/dataExercise/A2/Adverbs/Type5';
import type7data from '../../../../../listData/dataExercise/A2/Adverbs/Type7';



const dataForMarkers = {
  part: 'exercise',
  section: 'section2', // change section 
  class: 'class4' // change class
}

let option1 = [type1data, type5data, type4data, type3data, type2data, type7data]; 
let option2 = [type1data, type2data, type3data, type4data, type5data]; 
let option3 = [type1data, type7data, type4data, type2data, type5data]; 

const links1 = ['Exc2x5x1', 'Type5', 'Type4', 'Type3', 'Type2', 'Type7']; 
const links2 = ['Exc2x5x1', 'Type2', 'Type3', 'Type4', 'Type5']; 
const links3 = ['Exc2x5x1', 'Type7', 'Type4', 'Type2', 'Type5']; 
...
const Exc2x5x1 = ({route}) => {
  ...
  useEffect(() => {
    ...
    let type3dataNew = Object.keys(route.params.data).length === 0 ? type3data : parsedData.adverbs.type3
    let type4dataNew = Object.keys(route.params.data).length === 0 ? type4data : parsedData.adverbs.type4
    let type5dataNew = Object.keys(route.params.data).length === 0 ? type5data : parsedData.adverbs.type5
    ...
    option1 = [type1dataNew, type5dataNew, type4dataNew, type3dataNew, type2dataNew, type7dataNew];
    option2 = [type1dataNew, type2dataNew, type3dataNew, type4dataNew, type5dataNew];
    option3 = [type1dataNew, type7dataNew, type4dataNew, type2dataNew, type5dataNew];

    let tempArr = []; 
    let sumOfAllPoints = 0;

    let randomNumber = Math.floor(Math.random()* 3); //random number is based on nuber of arrays with options
...
export default Exc2x5x1  // change name here
