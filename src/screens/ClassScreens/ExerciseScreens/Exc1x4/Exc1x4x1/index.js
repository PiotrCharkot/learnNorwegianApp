...
let option1 = [type3data, type1data, type2data, type5data, type6data, type7data, type8data];
let option2 = [type3data, type1data, type4data, type5data];
let option3 = [type3data, type1data, type3data];

const links1 = ['Exc1x4x1', 'Type1', 'Type2', 'Type5', 'Type6', 'Type7', 'Type8'];
const links2 = ['Exc1x4x1', 'Type1', 'Type4', 'Type5'];
const links3 = ['Exc1x4x1', 'Type1', 'Type3'];
...
const Exc1x4x1 = ({ route }) => {
    ...
    useEffect(() => {
      ...
      option1 = [type3dataNew, type1data, type2data, type5data, type6data, type7data, type8data];
      option2 = [type3dataNew, type1data, type4data, type5data];
      option3 = [type3dataNew, type1data, type3dataNew];
