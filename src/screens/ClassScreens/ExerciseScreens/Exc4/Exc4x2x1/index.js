...
import type1data from '../../../../../listData/dataExercise/B2/PastPerfect/Type1';
import type4data from '../../../../../listData/dataExercise/B2/PastPerfect/Type4';
import type5data from '../../../../../listData/dataExercise/B2/PastPerfect/Type5';
import type7data from '../../../../../listData/dataExercise/B2/PastPerfect/Type7';
import type8data from '../../../../../listData/dataExercise/B2/PastPerfect/Type8';
...
let option1 = [type5data, type1data, type4data, type7data, type8data];
let option2 = [type5data, type7data, type1data, type8data, type5data];
let option3 = [type5data, type8data, type7data, type4data];

const links1 = ['Exc4x2x1', 'Type1', 'Type4', 'Type7', 'Type8'];
const links2 = ['Exc4x2x1', 'Type7', 'Type1', 'Type8', 'Type5'];
const links3 = ['Exc4x2x1', 'Type8', 'Type7', 'Type4'];
...
const Exc4x2x1 = ({route}) => {
    ...
    useEffect(() => {
      ...
      let type1dataNew = Object.keys(route.params.data).length === 0 ? type1data : parsedData.pastPerfectTense.type1;
      let type4dataNew = Object.keys(route.params.data).length === 0 ? type4data : parsedData.pastPerfectTense.type4;
      let type5dataNew = Object.keys(route.params.data).length === 0 ? type5data : parsedData.pastPerfectTense.type5;
      let type7dataNew = Object.keys(route.params.data).length === 0 ? type7data : parsedData.pastPerfectTense.type7;
      let type8dataNew = Object.keys(route.params.data).length === 0 ? type8data : parsedData.pastPerfectTense.type8;

      option1 = [type5dataNew, type1dataNew, type4dataNew, type7dataNew, type8dataNew];
      option2 = [type5dataNew, type7dataNew, type1dataNew, type8dataNew, type5dataNew];
      option3 = [type5dataNew, type8dataNew, type7dataNew, type4dataNew];
