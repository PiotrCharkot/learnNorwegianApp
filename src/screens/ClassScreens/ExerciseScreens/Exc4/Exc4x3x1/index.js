...
import type1data from '../../../../../listData/dataExercise/B2/Clause/Type1';
import type2data from '../../../../../listData/dataExercise/B2/Clause/Type2';
import type3data from '../../../../../listData/dataExercise/B2/Clause/Type3';
import type6data from '../../../../../listData/dataExercise/B2/Clause/Type6';
import type7data from '../../../../../listData/dataExercise/B2/Clause/Type7';
import type8data from '../../../../../listData/dataExercise/B2/Clause/Type8';
...
let option1 = [type8data, type1data, type3data, type6data, type7data];
let option2 = [type8data, type2data, type3data, type1data, type6data];
let option3 = [type8data, type3data, type7data, type8data];

const links1 = ['Exc4x3x1', 'Type1', 'Type3', 'Type6', 'Type7'];
const links2 = ['Exc4x3x1', 'Type2', 'Type3', 'Type1', 'Type6'];
const links3 = ['Exc4x3x1', 'Type3', 'Type7', 'Type8'];
...
const Exc4x3x1 = ({ route }) => {
    ...
    useEffect(() => {
      ...
      let type1dataNew = Object.keys(route.params.data).length === 0 ? type1data : parsedData.clause.type1;
      let type2dataNew = Object.keys(route.params.data).length === 0 ? type2data : parsedData.clause.type2;
      let type3dataNew = Object.keys(route.params.data).length === 0 ? type3data : parsedData.clause.type3;
      let type6dataNew = Object.keys(route.params.data).length === 0 ? type6data : parsedData.clause.type6;
      let type7dataNew = Object.keys(route.params.data).length === 0 ? type7data : parsedData.clause.type7;
      let type8dataNew = Object.keys(route.params.data).length === 0 ? type8data : parsedData.clause.type8;

      option1 = [type8dataNew, type1dataNew, type3dataNew, type6dataNew, type7dataNew];
      option2 = [type8dataNew, type2dataNew, type3dataNew, type1dataNew, type6dataNew];
      option3 = [type8dataNew, type3dataNew, type7dataNew, type8dataNew];
