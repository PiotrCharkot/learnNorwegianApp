...
import type1data from '../../../../../listData/dataExercise/B2/Genitive/Type1';
import type2data from '../../../../../listData/dataExercise/B2/Genitive/Type2';
import type4data from '../../../../../listData/dataExercise/B2/Genitive/Type4';
import type5data from '../../../../../listData/dataExercise/B2/Genitive/Type5';



const dataForMarkers = {
  part: 'exercise',
  section: 'section4', // change section 
  class: 'class3' // change class
}

let option1 = [type1data, type2data, type4data, type5data, type1data]; 
let option2 = [type1data, type5data, type4data, type2data, type1data]; 


const links1 = ['Exc4x4x1', 'Type2', 'Type4', 'Type5', 'Type1']; 
const links2 = ['Exc4x4x1', 'Type5', 'Type4', 'Type2', 'Type1']; 
...
const Exc4x4x1 = ({route}) => {
  ...
  useEffect(() => {
    ...
    let type1dataNew = Object.keys(route.params.data).length === 0 ? type1data : parsedData.genitive.type1;
    let type2dataNew = Object.keys(route.params.data).length === 0 ? type2data : parsedData.genitive.type2;
    let type4dataNew = Object.keys(route.params.data).length === 0 ? type4data : parsedData.genitive.type4;
    let type5dataNew = Object.keys(route.params.data).length === 0 ? type5data : parsedData.genitive.type5;

    // update options array with new parsed data from firebase if firebase connection === true

    option1 = [type1dataNew, type2dataNew, type4dataNew, type5dataNew, type1dataNew];
    option2 = [type1dataNew, type5dataNew, type4dataNew, type2dataNew, type1dataNew];
...
export default Exc4x4x1  // change name here
