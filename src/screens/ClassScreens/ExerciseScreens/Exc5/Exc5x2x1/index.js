...
import type1data from '../../../../../listData/dataExercise/C1/AllTenses/Type1';
import type3data from '../../../../../listData/dataExercise/C1/AllTenses/Type3';
import type4data from '../../../../../listData/dataExercise/C1/AllTenses/Type4';
import type5data from '../../../../../listData/dataExercise/C1/AllTenses/Type5';
import type6data from '../../../../../listData/dataExercise/C1/AllTenses/Type6';
import type8data from '../../../../../listData/dataExercise/C1/AllTenses/Type8';
...
let option1 = [type5data, type3data, type4data, type6data, type8data];
let option2 = [type5data, type1data, type6data, type4data, type3data];
let option3 = [type5data, type8data, type1data, type3data, type6data];

const links1 = ['Exc5x2x1', 'Type3', 'Type4', 'Type6', 'Type8'];
const links2 = ['Exc5x2x1', 'Type1', 'Type6', 'Type4', 'Type3'];
const links3 = ['Exc5x2x1', 'Type8', 'Type1', 'Type3', 'Type6'];
...
const Exc5x2x1 = ({route}) => {
    ...
    useEffect(() => {
      ...
      let type1dataNew = Object.keys(route.params.data).length === 0 ? type1data : parsedData.allTenses.type1;
      let type3dataNew = Object.keys(route.params.data).length === 0 ? type3data : parsedData.allTenses.type3;
      let type4dataNew = Object.keys(route.params.data).length === 0 ? type4data : parsedData.allTenses.type4;
      let type5dataNew = Object.keys(route.params.data).length === 0 ? type5data : parsedData.allTenses.type5;
      let type6dataNew = Object.keys(route.params.data).length === 0 ? type6data : parsedData.allTenses.type6;
      let type8dataNew = Object.keys(route.params.data).length === 0 ? type8data : parsedData.allTenses.type8;

      option1 = [type5dataNew, type3dataNew, type4dataNew, type6dataNew, type8dataNew];
      option2 = [type5dataNew, type1dataNew, type6dataNew, type4dataNew, type3dataNew];
      option3 = [type5dataNew, type8dataNew, type1dataNew, type3dataNew, type6dataNew];
