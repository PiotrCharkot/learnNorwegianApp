...
import type1data from '../../../../../listData/dataExercise/C1/Indirect/Type1';
import type4data from '../../../../../listData/dataExercise/C1/Indirect/Type4';
import type5data from '../../../../../listData/dataExercise/C1/Indirect/Type5';
import type8data from '../../../../../listData/dataExercise/C1/Indirect/Type8';
...
let option1 = [type5data, type1data, type4data, type8data, type5data];
let option2 = [type5data, type8data, type4data, type1data, type5data];

const links1 = ['Exc5x5x1', 'Type1', 'Type4', 'Type8', 'Type5'];
const links2 = ['Exc5x5x1', 'Type8', 'Type4', 'Type1', 'Type5'];
...
const Exc5x5x1 = ({route}) => {
    ...
    useEffect(() => {
      ...
      let type1dataNew = Object.keys(route.params.data).length === 0 ? type1data : parsedData.indirect.type1;
      let type4dataNew = Object.keys(route.params.data).length === 0 ? type4data : parsedData.indirect.type4;
      let type5dataNew = Object.keys(route.params.data).length === 0 ? type5data : parsedData.indirect.type5;
      let type8dataNew = Object.keys(route.params.data).length === 0 ? type8data : parsedData.indirect.type8;

      option1 = [type5dataNew, type1dataNew, type4dataNew, type8dataNew, type5dataNew];
      option2 = [type5dataNew, type8dataNew, type4dataNew, type1dataNew, type5dataNew];
