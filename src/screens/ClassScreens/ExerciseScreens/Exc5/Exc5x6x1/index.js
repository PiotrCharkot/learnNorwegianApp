...
import type1data from '../../../../../listData/dataExercise/C1/All/Type1';
import type3data from '../../../../../listData/dataExercise/C1/All/Type3';
import type4data from '../../../../../listData/dataExercise/C1/All/Type4';
import type5data from '../../../../../listData/dataExercise/C1/All/Type5';
import type6data from '../../../../../listData/dataExercise/C1/All/Type6';
import type8data from '../../../../../listData/dataExercise/C1/All/Type8';
...
let option1 = [type4data, type1data, type3data, type5data, type6data, type8data];
let option2 = [type4data, type5data, type1data, type3data, type6data];
let option3 = [type4data, type6data, type3data, type5data, type1data];

const links1 = ['Exc5x6x1', 'Type1', 'Type3', 'Type5', 'Type6', 'Type8'];
const links2 = ['Exc5x6x1', 'Type5', 'Type1', 'Type3', 'Type6'];
const links3 = ['Exc5x6x1', 'Type6', 'Type3', 'Type5', 'Type1'];
...
const Exc5x6x1 = ({route}) => {
    ...
    useEffect(() => {
      ...
      let type3dataNew = Object.keys(route.params.data).length === 0 ? type2data : parsedData.all.type3;
      ...
      option1 = [type4dataNew, type1dataNew, type3dataNew, type5dataNew, type6dataNew, type8dataNew];
      option2 = [type4dataNew, type5dataNew, type1dataNew, type3dataNew, type6dataNew];
      option3 = [type4dataNew, type6dataNew, type3dataNew, type5dataNew, type1dataNew];
