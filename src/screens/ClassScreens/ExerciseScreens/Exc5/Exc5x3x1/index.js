...
import type1data from '../../../../../listData/dataExercise/C1/Passive/Type1';
import type4data from '../../../../../listData/dataExercise/C1/Passive/Type4';
import type5data from '../../../../../listData/dataExercise/C1/Passive/Type5';
import type8data from '../../../../../listData/dataExercise/C1/Passive/Type8';
...
const dataForMarkers = {
  part: 'exercise',
  section: 'section5', // change section 
  class: 'class2' // change class
}

let option1 = [type1data, type4data, type5data, type8data, type1data]; 
let option2 = [type1data, type8data, type5data, type4data, type1data]; 

const links1 = ['Exc5x3x1', 'Type4', 'Type5', 'Type8', 'Type1']; 
const links2 = ['Exc5x3x1', 'Type8', 'Type5', 'Type4', 'Type1']; 
...
const Exc5x3x1 = ({route}) => {
  ...
  useEffect(() => {
    ...
    let type1dataNew = Object.keys(route.params.data).length === 0 ? type1data : parsedData.passive.type1;
    let type4dataNew = Object.keys(route.params.data).length === 0 ? type4data : parsedData.passive.type4;
    let type5dataNew = Object.keys(route.params.data).length === 0 ? type5data : parsedData.passive.type5;
    let type8dataNew = Object.keys(route.params.data).length === 0 ? type8data : parsedData.passive.type8;

    // update options array with new parsed data from firebase if firebase connection === true

    option1 = [type1dataNew, type4dataNew, type5dataNew, type8dataNew, type1dataNew];
    option2 = [type1dataNew, type8dataNew, type5dataNew, type4dataNew, type1dataNew];
...
export default Exc5x3x1  // change name here
