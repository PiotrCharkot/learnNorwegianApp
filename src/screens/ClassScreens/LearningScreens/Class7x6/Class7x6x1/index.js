    ...
    <View style={styles.mainContainer}>
        <ScrollView showsVerticalScrollIndicator={false} style={styles.body}>
          <View style={styles.topView}>
            <Text style={styles.title}>Tongue twisters and minimal pairs - Tongue twisters og minimale par</Text>
          </View>

          <View style={styles.middleView}>
            <Text style={styles.textGreeting}>
            Welcome back{user.isAnonymous ? <Text style={styles.textName}></Text> : <Text style={styles.textName}> {user.displayName}</Text>}!
            </Text>
            <Text style={styles.text}>
            This section provides engaging and practical ways to improve your Norwegian pronunciation. {'\n\n'}It includes <Text style={styles.textColor}>tongue twisters</Text> and <Text style={styles.textColor}>minimal pairs</Text> to help you master tricky sounds, stress and intonation. {'\n\n'}Let's take a look at some examples.
            </Text>
        ...
        <View style={styles.bottomBarContainer}>
          <BottomBar 
          linkNext={'Class7x6x2'} //link to next screen
...
export default Class7x6x1 // name for export
