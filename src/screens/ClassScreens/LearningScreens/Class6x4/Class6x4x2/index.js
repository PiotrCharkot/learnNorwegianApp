    ...
    <View style={styles.mainContainer}>
        <ScrollView showsVerticalScrollIndicator={false} style={styles.body}>
          ...
          <View style={styles.textContainer}>
            <Text style={styles.text}>We'll start with <Text style={styles.boldText}>mange</Text> and <Text style={styles.boldText}>få</Text>:</Text>
          </View>
          ...
          <View style={styles.exampleContainer}>
            <Text style={styles.exampleText}>få (few)</Text>
            <Text style={styles.textInEgz}></Text>
            <Text style={styles.textInEgz}>used with <Text style={styles.textColor}>countable</Text> nouns</Text>
            <Text style={styles.textInEgz}></Text>
            <Text style={styles.textInEgz}>Få venner - few friends</Text>
            <Text style={styles.textInEgz}>Få biler - few cars</Text>
          </View>
