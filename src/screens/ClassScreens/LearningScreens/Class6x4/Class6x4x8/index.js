...
const correctAnswers = ['Jeg', 'trenger', 'flere']; // array with correct words in line up to the word that goes in gap. exapmle ==> const correctAnswers = ['Jeg', 'trenger'];

const indexOfGaps = [2] // array with index of a gap in text
const indexOfText = [0, 1, 3] // array with indexes of text

const Class6x4x8 = ({ route }) => {  //screen name
    ...
    const [words, setWords] = useState(['Jeg', 'trenger' , '            ', 'blyanter.', '!!!' , 'much', 'mer' ,'få' ,'flere' , 'mange' ]); // arr with word in order, after '!!!' comes word to choose from
      ...
      <ProgressBar screenNum={currentScreen} totalLenghtNum={allScreensNum} latestScreen={latestScreenDone} comeBack={comeBackRoute}/>
        <View style={styles.body}>
            ...
            <View style={styles.topView}>
                ...
                <Text style={styles.textBody}>I need more pencils.</Text>
            </View>
        ...
        <View style={styles.bottomBarContainer}>
          ...
          linkNext={'Class6x4x9'} //link to next screen
          linkPrevious={'Class6x4x7'} //link to previous screen
          correctMsg={`You’re learning fast!`} //correct msg
...
export default Class6x4x8 //name for export
