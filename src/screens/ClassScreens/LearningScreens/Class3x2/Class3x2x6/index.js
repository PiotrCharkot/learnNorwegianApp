...
const Class3x2x6 = ({ route }) => { // name
    ...
    const [words, setWords] = useState(['sukker!', 'for', 'spis', 'mye', 'Ikke']); // words to sort in random order Ikke spis for mye sukker!
    ...
    <View style={styles.mainContainer}>
      ...
      <View style={styles.body}>
          ...
          <View style={styles.topView}>
              ...
              <Text style={styles.textBody}>(Don't eat too much sugar!)</Text>
          </View>
      ...
      <View style={styles.bottomBarContainer}>
        ...
        linkPrevious={'Class3x2x5'} //link previous screen
...
export default Class3x2x6 //name export
