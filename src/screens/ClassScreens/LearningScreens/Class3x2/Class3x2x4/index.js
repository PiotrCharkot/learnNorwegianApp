...
const wordsCorrect = [  // words in correct orders
    [
        ['Ikke', 'bruk', 'mobilen', 'under', 'middagen!']
    ]
]

const Class3x2x4 = ({ route }) => { // name
    ...
    const [words, setWords] = useState(['mobilen', 'bruk', 'middagen!', 'under', 'Ikke']); // words to sort in random order Ikke bruk mobilen under middagen!
    ...
    <View style={styles.mainContainer}>
      ...
      <View style={styles.body}>
          ...
          <View style={styles.topView}>
              <Text style={styles.questionText}>Rearrange the words to form a negative imperative sentence.</Text>
              <Text style={styles.textBody}>(Don't use your phone during dinner!)</Text>
          </View>
      ...
      <View style={styles.bottomBarContainer}>
        ...
        linkNext={'Class3x2x5'} //link next screen 
        linkPrevious={'Class3x2x3'} //link previous screen
...
export default Class3x2x4 //name export
