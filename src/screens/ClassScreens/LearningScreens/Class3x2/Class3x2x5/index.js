...
const Class3x2x5 = ({ route }) => { // name
    ...
    const [words, setWords] = useState(['til', 'sen', 'møtet!', 'vær', 'Ikke']); // words to sort in random order Ikke vær sen til møtet!
    ...
    <View style={styles.mainContainer}>
      ...
      <View style={styles.body}>
          ...
          <View style={styles.topView}>
              ...
              <Text style={styles.textBody}>(Don't be late for the meeting!)</Text>
          </View>
      ...
      <View style={styles.bottomBarContainer}>
        ...
        linkNext={'Class3x2x6'} //link next screen 
        linkPrevious={'Class3x2x4'} //link previous screen
...
export default Class3x2x5 //name export
