...
const answerOne = 'eksempler';  //answer a
const answerTwo = 'eksemplene'; //answer b
const answerThree = 'eksempelene'; //answer c
const answerFour = 'eksempeler'; //answer d
    ...
    <View style={styles.mainContainer}>
        <ScrollView showsVerticalScrollIndicator={false} style={styles.body}>
            ...
            <View style={styles.topView}>
                <Text style={styles.questionText}>Choose correct form for definite plural of 'en eksempel' (an example).</Text>
            </View>
        ...
        <View style={styles.bottomBarContainer}>
          ...
          linkPrevious={'Class4x2x7'} //link to previous screen
...
export default Class4x2x8 //name for export
