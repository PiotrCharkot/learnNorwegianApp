...
const answerOne = 'fottene';  //answer a
const answerTwo = 'føtene'; //answer b
const answerThree = 'føtter'; //answer c
const answerFour = 'føttene'; //answer d
const correctAnswers = [false, false, false, true];  //correct answer true or false


const Class4x2x7 = ({route}) => {  //name
    ...
    <View style={styles.mainContainer}>
        <ScrollView showsVerticalScrollIndicator={false} style={styles.body}>
            ...
            <View style={styles.topView}>
                <Text style={styles.questionText}>Choose correct form for definite plural of 'en fot' (a foot).</Text>
            </View>
        ...
        <View style={styles.bottomBarContainer}>
          ...
          linkNext={'Class4x2x8'}  //link to next screen
          linkPrevious={'Class4x2x6'} //link to previous screen
...
export default Class4x2x7 //name for export
