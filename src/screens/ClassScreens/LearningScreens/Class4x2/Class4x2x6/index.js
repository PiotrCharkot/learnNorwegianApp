...
const answerOne = 'sykkler';  //answer a
const answerTwo = 'sykler'; //answer b
const answerThree = 'sykkeler'; //answer c
const answerFour = 'sykeler'; //answer d
const correctAnswers = [false, true, false, false];  //correct answer true or false


const Class4x2x6 = ({route}) => {  //name
    ...
    <View style={styles.mainContainer}>
        <ScrollView showsVerticalScrollIndicator={false} style={styles.body}>
            ...
            <View style={styles.topView}>
                <Text style={styles.questionText}>Choose correct form for indefinite plural of 'en sykkel' (a bike).</Text>
            </View>
        ...
        <View style={styles.bottomBarContainer}>
          ...
          linkNext={'Class4x2x7'}  //link to next screen
          linkPrevious={'Class4x2x5'} //link to previous screen
          correctMsg={'That was first class work.'} //correct msg
          wrongMsg={`Drop one 'k' and drop 'e' from last syllable`} //wrong msg
...
export default Class4x2x6 //name for export
