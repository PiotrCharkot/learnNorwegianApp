    ...
    <View style={styles.mainContainer}>
        <ScrollView showsVerticalScrollIndicator={false} style={styles.body}>
          <View style={styles.topView}>
            <Text style={styles.title}>Irregular inflection - uregelmessig bøyning</Text>
          </View>
          ...
          <View style={styles.middleView}>
            ...
            <Text style={styles.text}>In Norwegian, <Text style={styles.textColor}>irregular inflection</Text> (<Text style={styles.textColor}>uregelmessig bøyning</Text>) of nouns refers to those nouns that do not follow the standard rules for forming plurals or changing definiteness. {'\n\n'}Irregular nouns may have different forms for the indefinite plural, definite plural, or both. {'\n\n'}Let's explore some of these irregular nouns in Norwegian together.
            </Text>
        ...
        <View style={styles.bottomBarContainer}>
          <BottomBar 
          linkNext={'Class4x2x2'} //link to next screen
...
export default Class4x2x1 // name for export
