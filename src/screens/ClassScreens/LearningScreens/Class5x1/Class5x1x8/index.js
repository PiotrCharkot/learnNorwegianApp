...
const answerOne = 'høy';  //answer a
const answerTwo = 'høyt'; //answer b
const answerThree = 'lang'; //answer c
const answerFour = 'langt'; //answer d
const correctAnswers = [false, false, false, true];  //correct answer true or false


const Class5x1x8 = ({route}) => {  //name
    ...
    <View style={styles.mainContainer}>
        <ScrollView showsVerticalScrollIndicator={false} style={styles.body}>
            ...
            <View style={styles.topView}>
                <Text style={styles.questionText}>Choose correct adverb.</Text>
                <Text style={styles.textBody}>Han bor ____ unna.</Text>
                <Text style={styles.textBody}>(He lives far away.)</Text>
            </View>
        ...
        <View style={styles.bottomBarContainer}>
          ...
          linkNext={'Class5x1x9'}  //link to next screen
          linkPrevious={'Class5x1x7'} //link to previous screen
          correctMsg={`Well done${user.isAnonymous ? '':  ` ${user.displayName}`}!`} //correct msg
          wrongMsg={`You've messed up${user.isAnonymous ? '':  ` ${user.displayName}`}!`} //wrong msg
...
export default Class5x1x8 //name for export
