...
const answerOne = 'dessverre';  //answer a
const answerTwo = 'muligens'; //answer b
const answerThree = 'derimot'; //answer c
const answerFour = 'kanskje'; //answer d
const correctAnswers = [false, true, false, true];  //correct answer true or false


const Class2x7x8 = ({route}) => {  //name
    ...
    <View style={styles.mainContainer}>
        <ScrollView showsVerticalScrollIndicator={false} style={styles.body}>
            ...
            <View style={styles.topView}>
                <Text style={styles.questionText}>Choose correct answers to expresses uncertainty or possibility. There maybe more than one correct answer.</Text>
                <Text style={styles.textBody}>Hun er _______ allerede på vei.</Text>
        ...
        <View style={styles.bottomBarContainer}>
          ...
          linkNext={'Class2x7x9'}  //link to next screen
          linkPrevious={'Class2x7x7'} //link to previous screen
          correctMsg={`That’s coming along nicely`} //correct msg
...
export default Class2x7x8 //name for export
