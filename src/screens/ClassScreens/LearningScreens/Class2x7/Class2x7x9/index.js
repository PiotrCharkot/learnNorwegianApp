...
const answerOne = 'definitivt';  //answer a
const answerTwo = 'antakelig'; //answer b
const answerThree = 'heldigvis'; //answer c
const answerFour = 'sikkert'; //answer d
const correctAnswers = [true, false, false, true];  //correct answer true or false


const Class2x7x9 = ({route}) => {  //name
    ...
    <View style={styles.mainContainer}>
        <ScrollView showsVerticalScrollIndicator={false} style={styles.body}>
            ...
            <View style={styles.topView}>
                <Text style={styles.questionText}>Choose correct answers to expresses confidence. There maybe more than one correct answer.</Text>
                <Text style={styles.textBody}>Vi vil ________ besøke deg snart.</Text>
        ...
        <View style={styles.bottomBarContainer}>
          ...
          linkNext={'Class2x7x10'}  //link to next screen
          linkPrevious={'Class2x7x8'} //link to previous screen
          correctMsg={`Keep it up${user.isAnonymous ? '':  ` ${user.displayName}`}!`} //correct msg
          wrongMsg={'There are two correct answers'} //wrong msg
...
export default Class2x7x9 //name for export
