    ...
    <View style={styles.mainContainer}>
        <ScrollView showsVerticalScrollIndicator={false} style={styles.body}>
          ...
          <View style={styles.textContainer}>
            <Text style={styles.text}><Text style={styles.boldText}>Definite singular articles:</Text></Text>
          </View>
          ...
          <View style={styles.exampleContainer}>
            <Text style={styles.exampleText}>-a or -en</Text>
        ...
        <View style={styles.bottomBarContainer}>
          <BottomBar 
          linkNext={'Class4x1x8'} //link next screen 
          linkPrevious={'Class4x1x6'} // link previous screen
...
export default Class4x1x7  //name export 
