...
const answerOne = 'seng';  //answer a
const answerTwo = 'senger'; //answer b
const answerThree = 'sengene'; //answer c
const answerFour = 'sengen'; //answer d
    ...
    <View style={styles.mainContainer}>
        <ScrollView showsVerticalScrollIndicator={false} style={styles.body}>
            ...
            <View style={styles.topView}>
                <Text style={styles.questionText}>Choose the correct definite singular form of the noun 'a bed' (the bed).</Text>
        ...
        <View style={styles.bottomBarContainer}>
          ...
          linkPrevious={'Class4x1x12'} //link to previous screen
...
export default Class4x1x13 //name for export
