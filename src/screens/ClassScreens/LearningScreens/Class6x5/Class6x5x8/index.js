...
const Class6x5x8 = ({ route }) => { // name
    ...
    const [words, setWords] = useState(['kan', 'alt', 'noe',  'gjøre', 'men', 'kan', 'alle', 'Ingen',  'gjøre',]); // words to sort in random order
    ...
    <View style={styles.mainContainer}>
      ...
      <View style={styles.body}>
          ...
          <View style={styles.topView}>
              ...
              <Text style={styles.textBody}>No one can do everything, but everyone can do something.</Text>
          </View>
      ...
      <View style={styles.bottomBarContainer}>
        ...
        linkNext={'Class6x5x9'} //link next screen 
        linkPrevious={'Class6x5x7'} //link previous screen
        correctMsg={`Way to go${user.isAnonymous ? '':  ` ${user.displayName}`}!`} //correct msg
        wrongMsg={'Ingen kan gjøre alt, men alle kan...'} //wrong msg
...
export default Class6x5x8 //name export
