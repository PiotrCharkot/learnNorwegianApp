    ...
    <View style={styles.mainContainer}>
        <ScrollView showsVerticalScrollIndicator={false} style={styles.body}>
          <View style={styles.topView}>
            <Text style={styles.title}>Demonstrative pronouns and question words</Text>
          </View>
          ...
          <View style={styles.middleView}>
            ...
            <Text style={styles.text}><Text style={styles.textColor}>Demonstrative pronouns</Text> in Norwegian are used to point out specific objects or people. {'\n\n'}They are often used to differentiate between items that are near or far. {'\n\n'}There are two main demonstrative pronouns: {'\n\n'}- "<Text style={styles.boldText}>denne</Text>" (this) and "<Text style={styles.boldText}>den</Text>" (that) for singular nouns, {'\n'}- "<Text style={styles.boldText}>disse</Text>" (these) and "<Text style={styles.boldText}>de</Text>" (those) for plural nouns
            </Text>
        ...
        <View style={styles.bottomBarContainer}>
          <BottomBar 
          linkNext={'Class6x3x2'} //link to next screen
...
export default Class6x3x1 // name for export
