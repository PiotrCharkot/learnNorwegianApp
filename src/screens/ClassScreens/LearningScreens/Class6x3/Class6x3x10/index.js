...
const correctAnswers = ['Hvordan']; // array with correct words in line up to the word that goes in gap. exapmle ==> const correctAnswers = ['Jeg', 'trenger'];

const indexOfGaps = [0] // array with index of a gap in text
const indexOfText = [1, 2, 3, 4] // array with indexes of text

const Class6x3x10 = ({ route }) => {  //screen name
    ...
    const [words, setWords] = useState(['            ' , 'lager', 'du', 'denne', 'retten?','!!!' , 'Hvem' ,'Hvor' ,'Hvordan', 'Når' , 'Hvorfor' ]); // arr with word in order, after '!!!' comes word to choose from
      ...
      <ProgressBar screenNum={currentScreen} totalLenghtNum={allScreensNum} latestScreen={latestScreenDone} comeBack={comeBackRoute}/>
        <View style={styles.body}>
            ...
            <View style={styles.topView}>
                ...
                <Text style={styles.textBody}>How do you make this dish?</Text>
            </View>
        ...
        <View style={styles.bottomBarContainer}>
          ...
          linkNext={'Class6x3x11'} //link to next screen
          linkPrevious={'Class6x3x9'} //link to previous screen
...
export default Class6x3x10 //name for export
