    ...
    <View style={styles.mainContainer}>
        <ScrollView showsVerticalScrollIndicator={false} style={styles.body}>
          <View style={styles.topView}>
            <Text style={styles.title}>Irregular degree of comparison - Uregelmessig gradbøyning</Text>
          </View>
          ...
          <View style={styles.middleView}>
            ...
            <Text style={styles.text}>There is number of adjectives that do not follow the regular rules for degree of comparison as explained in previous section. {'\n\n'}Instead, they have unique comparative and superlative forms. {'\n\n'}Let's meet a few of these irregularly inflected adjectives!</Text>
        ...
        <View style={styles.bottomBarContainer}>
          <BottomBar 
          linkNext={'Class5x5x2'} //link to next screen
...
export default Class5x5x1 // name for export
