...
const wordsCorrect = [  // words in correct orders
    [
        ['Han', 'elsker', 'henne', 'og', 'hun', 'elsker', 'ham']
    ]
]

const Class6x1x6 = ({ route }) => { // name
    ...
    const [words, setWords] = useState(['hun', 'og', 'elsker', 'henne', 'elsker', 'ham', 'Han']); // words to sort in random order Han elsker henne og hun elsker ham.
    ...
    <View style={styles.mainContainer}>
      ...
      <View style={styles.body}>
          ...
          <View style={styles.topView}>
              ...
              <Text style={styles.textBody}>He loves her and she loves him.</Text>
          </View>
      ...
      <View style={styles.bottomBarContainer}>
        ...
        linkNext={'Class6x1x7'} //link next screen 
        linkPrevious={'Class6x1x5'} //link previous screen
        correctMsg={'Keep up the good work'} //correct msg
        wrongMsg={'Han elsker henne og...'} //wrong msg
...
export default Class6x1x6 //name export
