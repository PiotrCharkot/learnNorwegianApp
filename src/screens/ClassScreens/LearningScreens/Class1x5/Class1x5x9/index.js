...
const wordsCorrect = [  // words in correct orders
    [
        ['Han', 'hadde', 'fullført', 'prosjektet', 'før', 'fristen.'],
        ['prosjektet', 'hadde', 'Han', 'fullført', 'før', 'fristen.'],
        ['før', 'fristen.', 'hadde', 'Han', 'fullført', 'prosjektet'],
    ]
]

const Class1x5x9 = ({ route }) => { // name
    ...
    const [words, setWords] = useState(['hadde', 'fristen.', 'prosjektet', 'Han', 'før', 'fullført' ]); // words to sort in random order Han hadde fullført prosjektet før fristen.
  ...
  return (
    <View style={styles.mainContainer}>
      <ProgressBar screenNum={currentScreen} totalLenghtNum={allScreensNum} latestScreen={latestScreenDone} comeBack={comeBackRoute}/>
        <View style={styles.body}>
            ...
            <View style={styles.topView}>
                <Text style={styles.questionText}>Drag and arrange words to form a positive sentence in past perfect tense.</Text>
                <Text style={styles.textBody}>(He had finished the project before the deadline.)</Text>
            </View>
      ...
      <View style={styles.bottomBarContainer}>
        ...
        linkPrevious={'Class1x5x8'} //link previous screen
...
export default Class1x5x9 //name export
