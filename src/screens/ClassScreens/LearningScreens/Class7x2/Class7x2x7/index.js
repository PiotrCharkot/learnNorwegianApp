...
const Class7x2x7 = ({route}) => { //name for component
    ...
    const soundD = 'https://firebasestorage.googleapis.com/v0/b/norapp-69bd4.appspot.com/o/wordsList1%2FVLangYsentence.mp3?alt=media&token=1f6cb5ff-1441-4f9d-b379-2d2668acc003';
    ...
    <View style={styles.mainContainer}>
        <ScrollView showsVerticalScrollIndicator={false} style={styles.body}>
          ...
          <TouchableOpacity onPress={() => {playSound(soundC)}}>
            <View style={styles.exampleContainer}>
                <Image style={styles.pictureSoundInContainer} source={require('../../../../../../assets/volume.png')} />
                <Text style={styles.exampleText}>et l<Text style={styles.exampleTextColor}>y</Text>s - <Text style={styles.exampleTextTrans}>/lyːs/</Text></Text>
                <Text style={styles.exampleTextTrans}>a light</Text>
            </View>
          </TouchableOpacity>
            ...
            <TouchableOpacity onPress={() => {playSound(soundD)}}>
                <View style={styles.exampleContainer}>
                    <Image style={styles.pictureSoundInContainer} source={require('../../../../../../assets/volume.png')} />
                    <Text style={styles.exampleText}>Lyset i rommet var sterkt.</Text>
                    <Text style={styles.exampleTextTrans}>The light in the room was bright.</Text>
                </View>
            </TouchableOpacity>
        ...
        <View style={styles.bottomBarContainer}>
          ...
          linkNext={'Class7x2x8'} //link next
          linkPrevious={'Class7x2x6'} //link previous
...
export default Class7x2x7 //name for export
