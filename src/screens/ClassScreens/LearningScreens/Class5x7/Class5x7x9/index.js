...
const correctAnswers = ['Jeg', 'så', 'en', 'løpende']; // array with correct words in line up to the word that goes in gap. exapmle ==> const correctAnswers = ['Jeg', 'trenger'];

const indexOfGaps = [3] // array with index of a gap in text
const indexOfText = [0, 1, 2, 4, 5, 6] // array with indexes of text

const Class5x7x9 = ({ route }) => {  //screen name
    ...
    const [words, setWords] = useState(['Jeg', 'så', 'en', '            ', 'hund', 'i', 'parken.','!!!' , 'løpe', 'løpende' ,'løpt', 'løpes' ]); // arr with word in order, after '!!!' comes word to choose from Jeg så en løpende hund i parken.
      ...
      <ProgressBar screenNum={currentScreen} totalLenghtNum={allScreensNum} latestScreen={latestScreenDone} comeBack={comeBackRoute}/>
        <View style={styles.body}>
            ...
            <View style={styles.topView}>
                ...
                <Text style={styles.textBody}>I saw a <Text style={styles.textColor}>running</Text> dog in the park.</Text>
            </View>
        ...
        <View style={styles.bottomBarContainer}>
          ...
          linkNext={'Class5x7x10'} //link to next screen
          linkPrevious={'Class5x7x8'} //link to previous screen
...
export default Class5x7x9 //name for export
