...
const correctAnswers = ['Våren', 'er', 'varmere']; // array with correct words in line up to the word that goes in gap. exapmle ==> const correctAnswers = ['Jeg', 'trenger'];

const indexOfGaps = [2] // array with index of a gap in text
const indexOfText = [0, 1, 3, 4] // array with indexes of text

const Class5x4x8 = ({ route }) => {  //screen name
    ...
    const [words, setWords] = useState(['Våren', 'er', '            ', 'enn', 'vinteren.' ,'!!!' , 'varmest', 'varm' ,'den varmeste' ,'varmere' ]); // arr with word in order, after '!!!' comes word to choose from Våren er varmere enn vinteren.
      ...
      <ProgressBar screenNum={currentScreen} totalLenghtNum={allScreensNum} latestScreen={latestScreenDone} comeBack={comeBackRoute}/>
        <View style={styles.body}>
            ...
            <View style={styles.topView}>
                ...
                <Text style={styles.textBody}>Spring is warmer than winter.</Text>
            </View>
        ...
        <View style={styles.bottomBarContainer}>
          ...
          linkPrevious={'Class5x4x7'} //link to previous screen
          correctMsg={`You’ve got it made!`} //correct msg
...
export default Class5x4x8 //name for export
