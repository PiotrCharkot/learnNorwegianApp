...
const correctAnswers = ['Du', 'ser', 'mindre']; // array with correct words in line up to the word that goes in gap. exapmle ==> const correctAnswers = ['Jeg', 'trenger'];

const indexOfGaps = [2] // array with index of a gap in text
const indexOfText = [0, 1, 3, 4, 5, 6] // array with indexes of text

const Class5x6x7 = ({ route }) => {  //screen name
    ...
    const [words, setWords] = useState(['Du', 'ser','            ', 'trøtt', 'ut', 'i', 'dag.' ,'!!!' , 'mest' ,'minst' ,'mer' , 'mindre' ]); // arr with word in order, after '!!!' comes word to choose from Du ser mindre trøtt ut i dag.
      ...
      <ProgressBar screenNum={currentScreen} totalLenghtNum={allScreensNum} latestScreen={latestScreenDone} comeBack={comeBackRoute}/>
        <View style={styles.body}>
            ...
            <View style={styles.topView}>
                ...
                <Text style={styles.textBody}>You look less tired today.</Text>
            </View>
        ...
        <View style={styles.bottomBarContainer}>
          ...
          linkNext={'Class5x6x8'} //link to next screen
          linkPrevious={'Class5x6x6'} //link to previous screen
          correctMsg={'Veldig bra!'} //correct msg
          wrongMsg={'Det er feil!'} //wrong msg
...
export default Class5x6x7 //name for export
