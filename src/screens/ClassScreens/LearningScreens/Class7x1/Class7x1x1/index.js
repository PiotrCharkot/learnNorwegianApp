    ...
    <View style={styles.mainContainer}>
        <ScrollView showsVerticalScrollIndicator={false} style={styles.body}>
          <View style={styles.topView}>
            <Text style={styles.title}>Vowels - vokaler</Text>
          </View>

          <View style={styles.middleView}>
            <Text style={styles.textGreeting}>
            Welcome to Norwegian Vowels{user.isAnonymous ? <Text style={styles.textName}></Text> : <Text style={styles.textName}> {user.displayName}</Text>}!
            </Text>
            <Text style={styles.text}>
            Norwegian <Text style={styles.textColor}>vowels</Text> are key to clear pronunciation!  {'\n\n'}
            There are 9 vowels:  {'\n\n'}
            <Text style={styles.textColorBold}>a, e, i, o, u, y, æ, ø, å</Text>

            {'\n\n'}Let's have a look at pronunciation of each vowel and some examples.
            </Text>
        ...
        <View style={styles.bottomBarContainer}>
          <BottomBar 
          linkNext={'Class7x1x2'} //link to next screen
...
export default Class7x1x1 // name for export
