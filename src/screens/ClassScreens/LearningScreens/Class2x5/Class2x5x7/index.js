...
const wordsCorrect = [  // words in correct orders
    [
        ['Hvis', 'du', 'sov', 'nok', 'skulle', 'du', 'føle deg', 'bedre.']
    ]
]

const Class2x5x7 = ({ route }) => { // name
    ...
    const [words, setWords] = useState(['du', 'skulle', 'du', 'nok', 'føle deg', 'sov', 'bedre.', 'Hvis']); // words to sort in random order
  ...
  return (
    <View style={styles.mainContainer}>
      ...
      <View style={styles.bottomBarContainer}>
        ...
        linkNext={'Class2x5x8'} //link next screen 
        linkPrevious={'Class2x5x6'} //link previous screen
        correctMsg={`Well done${user.isAnonymous ? '':  ` ${user.displayName}`}!`} //correct msg
        wrongMsg={`Hvis du sov nok, skulle du...`} //wrong msg
...
export default Class2x5x7 //name export
