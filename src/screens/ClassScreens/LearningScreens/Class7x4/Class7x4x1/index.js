    ...
    <View style={styles.mainContainer}>
        <ScrollView showsVerticalScrollIndicator={false} style={styles.body}>
          <View style={styles.topView}>
            <Text style={styles.title}>Silent letters - Stumme bokstaver</Text>
          </View>
          ...
          <View style={styles.middleView}>
            ...
            Sometimes, Norwegian words contain letters that you don’t actually pronounce. {'\n\n'}These letters, known as <Text style={styles.textColor}>stumme bokstaver</Text>, often appear in certain word forms and can easily throw you off if you’re not prepared. {'\n\n'}By figuring out which letters are silent and when they occur, you’ll sound more natural when you speak Norwegian.
            </Text>
        ...
        <View style={styles.bottomBarContainer}>
          <BottomBar 
          linkNext={'Class7x4x2'} //link to next screen
...
export default Class7x4x1 // name for export
