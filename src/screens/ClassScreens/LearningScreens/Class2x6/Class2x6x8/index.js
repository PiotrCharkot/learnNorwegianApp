    ...
    <View style={styles.mainContainer}> 
        <ScrollView showsVerticalScrollIndicator={false} style={styles.body}>
          <View style={styles.textContainer}>
            <Text style={styles.text}><Text style={styles.boldText}>Purpose</Text>: <Text style={styles.textColor}>Adverbials</Text> that describe the reason or purpose of an action.</Text>
          </View>
        ...
        <View style={styles.bottomBarContainer}>
          <BottomBar 
          linkNext={'Class2x6x9'} //link to next screen
          linkPrevious={'Class2x6x7'}  //link to previous screen
...
export default Class2x6x8 //name for export
