...
const wordsCorrect = [  // words in correct orders
    [
        ['Hun', 'snakker', 'sakte', 'for', 'at', 'alle', 'skal', 'forstå'],
    ]
]

const Class2x6x11 = ({ route }) => { // name
    ...
    const [words, setWords] = useState(['alle', 'at', 'forstå', 'Hun', 'sakte', 'for', 'skal', 'snakker']); // Hun snakker sakte for at alle skal forstå.
    ...
    <View style={styles.mainContainer}>
      ...
      <View style={styles.body}>
          ...
          <View style={styles.topView}>
              <Text style={styles.questionText}>Arrange the words so that the verb is followed first by adverbials of manner and then by adverbials of purpose.</Text>
              <Text style={styles.textBody}>(She speaks slowly so that everyone understands.)</Text>
          </View>
      ...
      <View style={styles.bottomBarContainer}>
        ...
        linkPrevious={'Class2x6x10'} //link previous screen
        correctMsg={`Good for you${user.isAnonymous ? '':  ` ${user.displayName}`}!`} //correct msg
        wrongMsg={'Hun snakker sakte for at...'} //wrong msg
...
export default Class2x6x11 //name export
