...
const answerOne = 'sjelden';  //answer a
const answerTwo = 'vanligvis'; //answer b
const answerThree = 'alltid'; //answer c
const answerFour = 'aldri'; //answer d
const correctAnswers = [false, true, false, false];  //correct answer true or false


const Class2x6x9 = ({route}) => {  //name
    ...
    <View style={styles.mainContainer}>
        <ScrollView showsVerticalScrollIndicator={false} style={styles.body}>
            ...
            <View style={styles.topView}>
                <Text style={styles.questionText}>Choose correct adverbial that describes frequency of an action.</Text>
                <Text style={styles.textBody}>Han trener _______ hver dag.</Text>
                <Text style={styles.textBody}>(He usually trains every day.)</Text>
            </View>
        ...
        <View style={styles.bottomBarContainer}>
          ...
          linkNext={'Class2x6x10'}  //link to next screen
          linkPrevious={'Class2x6x8'} //link to previous screen
          correctMsg={'vanligvis is correct!'} //correct msg
...
export default Class2x6x9 //name for export
