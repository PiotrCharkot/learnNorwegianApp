...
const Class5x3x12 = ({ route }) => {  //screen name
      ...
      <ProgressBar screenNum={currentScreen} totalLenghtNum={allScreensNum} latestScreen={latestScreenDone} comeBack={comeBackRoute}/>
        <View style={styles.body}>
            ...
            <View style={styles.topView}>
                <Text style={styles.questionText}>Drag the correct form of adjective 'small' into the gap.</Text>
                <Text style={styles.textBody}>We have a <Text style={styles.textColor}>small</Text> child at home.</Text>
            </View>
        ...
        <View style={styles.bottomBarContainer}>
          ...
          linkPrevious={'Class5x3x11'} //link to previous screen
...
export default Class5x3x12 //name for export
