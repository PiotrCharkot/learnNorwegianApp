...
const wordsCorrect = [  // words in correct orders
    [
        ['Barnet', 'som', 'leker', 'i', 'parken', 'er', 'datteren', 'min'],
        ['datteren', 'min', 'er', 'Barnet', 'som', 'leker', 'i', 'parken'],
    ]
]

const Class4x5x8 = ({ route }) => { // name
    ...
    const [words, setWords] = useState(['min', 'er', 'i', 'som', 'datteren', 'leker', 'parken','Barnet']); // words to sort in random order Barnet som leker i parken er datteren min.
    ...
    <View style={styles.mainContainer}>
      ...
      <View style={styles.body}>
          ...
          <View style={styles.topView}>
              ...
              <Text style={styles.textBody}>The child who is playing in the park is my daughter.</Text>
          </View>
      ...
      <View style={styles.bottomBarContainer}>
        ...
        linkNext={'Class4x5x9'} //link next screen 
        linkPrevious={'Class4x5x7'} //link previous screen
        correctMsg={`That’s coming along nicely`} //correct msg
        wrongMsg={`Barnet som leker i parken...`} //wrong msg
...
export default Class4x5x8 //name export
