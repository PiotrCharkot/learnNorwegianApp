    ...
    <View style={styles.mainContainer}> 
        <ScrollView showsVerticalScrollIndicator={false} style={styles.body}>
          <View style={styles.textContainer}>
            <Text style={styles.text}>Look at this example:</Text>
          </View>

          <View style={styles.exampleContainer}>
            <Text style={styles.exampleTextSmall}>Jeg liker det vakre huset ved sjøen.</Text>
            <Text style={styles.textSmall}>I like the beautiful house by the sea.</Text>
          ...
          <View style={styles.textContainer}>
            <Text style={styles.text}>Adverbs of place (e.g."ved sjøen", "i Oslo") stand behind the noun. {'\n\n'}Demonstrative pronouns (e.g. "det" , "disse" , "denne", etc.) come before the noun.</Text>
          </View>
        ...
        <View style={styles.bottomBarContainer}>
          <BottomBar 
          linkNext={'Class4x5x5'} //link to next screen
          linkPrevious={'Class4x5x3'}  //link to previous screen
...
export default Class4x5x4 //name for export
