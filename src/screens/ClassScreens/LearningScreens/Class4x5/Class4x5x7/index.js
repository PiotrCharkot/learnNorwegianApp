...
const wordsCorrect = [  // words in correct orders
    [
        ['Huset', 'han', 'bor', 'i', 'er', 'veldig', 'gammelt'],
    ]
]

const Class4x5x7 = ({ route }) => { // name
    ...
    const [words, setWords] = useState(['i', 'gammelt', 'veldig', 'han', 'bor', 'er', 'Huset']); // words to sort in random order Huset han bor i er veldig gammelt.
    ...
    <View style={styles.mainContainer}>
      ...
      <View style={styles.body}>
          ...
          <View style={styles.topView}>
              ...
              <Text style={styles.textBody}>The house he lives in is very old.</Text>
          </View>
      ...
      <View style={styles.bottomBarContainer}>
        ...
        linkNext={'Class4x5x8'} //link next screen 
        linkPrevious={'Class4x5x6'} //link previous screen
        correctMsg={`You’re doing a great job!`} //correct msg
        wrongMsg={`Huset han bor i...`} //wrong msg
...
export default Class4x5x7 //name export
