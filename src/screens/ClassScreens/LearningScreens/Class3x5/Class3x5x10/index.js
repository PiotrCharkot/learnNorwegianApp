...
const wordsCorrect = [  // words in correct orders
    [
        ...
        ['tiden', 'din', 'kaster', 'Du', 'bort']
    ]
]

const Class3x5x10 = ({ route }) => { // name
    ...
    const [words, setWords] = useState(['bort', 'din', 'kaster', 'tiden', 'Du']); // words to sort in random order Du kaster bort tiden din. 
    ...
    <View style={styles.mainContainer}>
      ...
      <View style={styles.body}>
          ...
          <View style={styles.topView}>
              ...
              <Text style={styles.textBody}>(You're wasting your time.)</Text>
          </View>
      ...
      <View style={styles.bottomBarContainer}>
        ...
        linkPrevious={'Class3x5x9'} //link previous screen
        correctMsg={`Wow...`} //correct msg
        wrongMsg={`Du kaster bort tiden...`} //wrong msg
...
export default Class3x5x10 //name export
