...
const answerOne = 'gikk ikke tom for';  //answer a
const answerTwo = 'tok ikke hensyn til'; //answer b
const answerThree = 'la ikke merke til'; //answer c
const answerFour = 'ga ikke opp'; //answer d
const correctAnswers = [false, false, true, false];  //correct answer true or false


const Class3x5x8 = ({route}) => {  //name
    ...
    <View style={styles.mainContainer}>
        <ScrollView showsVerticalScrollIndicator={false} style={styles.body}>
            ...
            <View style={styles.topView}>
                <Text style={styles.questionText}>Which answer is correct?</Text>
                <Text style={styles.textBody}>Han _____________ at hun hadde klippet håret.</Text>
                <Text style={styles.textBody}>(He didn't notice that she had cut her hair.)</Text>
            </View>
        ...
        <View style={styles.bottomBarContainer}>
          ...
          linkNext={'Class3x5x9'}  //link to next screen
          linkPrevious={'Class3x5x7'} //link to previous screen
...
export default Class3x5x8 //name for export
