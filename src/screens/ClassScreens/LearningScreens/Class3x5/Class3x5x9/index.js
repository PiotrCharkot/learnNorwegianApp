...
const wordsCorrect = [  // words in correct orders
    [
        ['Jeg', 'har', 'gått', 'tom', 'for', 'kaffe'],
        ['kaffe', 'har', 'Jeg', 'gått', 'tom', 'for']
    ]
]

const Class3x5x9 = ({ route }) => { // name
    ...
    const [words, setWords] = useState(['gått', 'for', 'Jeg', 'kaffe', 'har', 'tom']); // words to sort in random order Jeg har gått tom for kaffe. 
    ...
    <View style={styles.mainContainer}>
      ...
      <View style={styles.body}>
          ...
          <View style={styles.topView}>
              ...
              <Text style={styles.textBody}>(I have run out of coffee.)</Text>
          </View>
      ...
      <View style={styles.bottomBarContainer}>
        ...
        linkNext={'Class3x5x10'} //link next screen 
        linkPrevious={'Class3x5x8'} //link previous screen
        correctMsg={`Kunne ikke gjort det bedre selv.`} //correct msg
        wrongMsg={`Jeg har gått tom...`} //wrong msg
...
export default Class3x5x9 //name export
