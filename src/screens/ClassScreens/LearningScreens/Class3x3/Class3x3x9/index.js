...
const answerOne = 'ble selge';  //answer a
const answerTwo = 'vil bli selge'; //answer b
const answerThree = 'har blitt solgt'; //answer c
const answerFour = 'vil bli solgt'; //answer d
const correctAnswers = [false, false, false, true];  //correct answer true or false


const Class3x3x9 = ({route}) => {  //name
    ...
    <View style={styles.mainContainer}>
        <ScrollView showsVerticalScrollIndicator={false} style={styles.body}>
            ...
            <View style={styles.topView}>
                <Text style={styles.questionText}>Choose correct answer to create passive voice in future tense.</Text>
                <Text style={styles.textBody}>Alle billettene __________ innen morgendagen.</Text>
            </View>
        ...
        <View style={styles.bottomBarContainer}>
          ...
          linkNext={'Class3x3x10'}  //link to next screen
          linkPrevious={'Class3x3x8'} //link to previous screen
          correctMsg={`Well, look at you go${user.isAnonymous ? '':  ` ${user.displayName}`}!`} //correct msg
...
export default Class3x3x9 //name for export
