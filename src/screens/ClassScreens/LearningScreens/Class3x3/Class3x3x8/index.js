...
const wordsCorrect = [  // words in correct orders
    [
        ['Katten', 'ble', 'tatt', 'vare', 'på', 'av', 'naboene'],
    ]
]

const Class3x3x8 = ({ route }) => { // name
    ...
    const [words, setWords] = useState(['på', 'tatt', 'vare', 'ble', 'av', 'Katten', 'naboene']); // words to sort in random order Katten ble tatt vare på av naboene.
    ...
    <View style={styles.mainContainer}>
      ...
      <View style={styles.body}>
          ...
          <View style={styles.topView}>
              <Text style={styles.questionText}>Rearrange the words to form a passive voice in the past tense.</Text>
              <Text style={styles.textBody}>(The cat was taken care of by the neighbors.)</Text>
          </View>
      ...
      <View style={styles.bottomBarContainer}>
        ...
        linkNext={'Class3x3x9'} //link next screen 
        linkPrevious={'Class3x3x7'} //link previous screen
        correctMsg={`You’re getting better every day.`} //correct msg
        wrongMsg={'Katten ble tatt vare på...'} //wrong msg
...
export default Class3x3x8 //name export
