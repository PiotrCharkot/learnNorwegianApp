    ...
    <View style={styles.mainContainer}> 
        <ScrollView showsVerticalScrollIndicator={false} style={styles.body}>
          <View style={styles.textContainer}>
            <Text style={styles.text}>You could say:</Text>
          </View>
          ...
          <View style={styles.textContainer}>
            <Text style={styles.text}>Here noun (stolen - chair) has to be in <Text style={styles.boldText}>definite</Text> form. However if you want to emphasize who the owner of the chair is, you should place <Text style={styles.textColor}>pronun</Text> <Text style={styles.textUnderline}>before</Text> noun. In this case noun has to be in <Text style={styles.boldText}>indefinite</Text> form (stol).</Text>
          </View>
        ...
        <View style={styles.bottomBarContainer}>
          <BottomBar 
          linkNext={'Class6x2x9'} //link to next screen
          linkPrevious={'Class6x2x7'}  //link to previous screen
...
export default Class6x2x8 //name for export
