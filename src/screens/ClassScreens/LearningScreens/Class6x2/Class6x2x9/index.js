...
const answerOne = 'sin';  //answer a
const answerTwo = 'si'; //answer b
const answerThree = 'sitt'; //answer c
const answerFour = 'sine'; //answer d
const correctAnswers = [false, false, false, true];  //correct answer true or false


const Class6x2x9 = ({route}) => {  //name
    ...
    <View style={styles.mainContainer}>
        <ScrollView showsVerticalScrollIndicator={false} style={styles.body}>
            ...
            <View style={styles.topView}>
                ...
                <Text style={styles.textBody}>Han mistet _____ nøkler.</Text>
                <Text style={styles.textBody}>He lost his own keys.</Text>
            </View>
        ...
        <View style={styles.bottomBarContainer}>
          ...
          linkNext={'Class6x2x10'}  //link to next screen
          linkPrevious={'Class6x2x8'} //link to previous screen
          correctMsg={'Outstanding!!!'} //correct msg
          wrongMsg={`'nøkler' is plural...`} //wrong msg
...
export default Class6x2x9 //name for export
