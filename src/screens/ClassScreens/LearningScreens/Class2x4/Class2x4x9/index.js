...
const answerOne = 'jeg går';  //answer a
const answerTwo = 'hennes gikk'; //answer b
const answerThree = 'hun gikk'; //answer c
const answerFour = 'hun går'; //answer d
    ...
    <View style={styles.mainContainer}>
        <ScrollView showsVerticalScrollIndicator={false} style={styles.body}>
            ...
            <View style={styles.topView}>
                ...
                <Text style={styles.textBody}>Direct: Hun sa, "Jeg går til butikken."</Text>
                <Text style={styles.textBody}>Indirect: Hun sa at ________ til butikken.</Text>
                <Text style={styles.textBody}>(She said she went to the store.)</Text>
            </View>
        ...
        <View style={styles.bottomBarContainer}>
          ...
          linkNext={'Class2x4x10'}  //link to next screen
          linkPrevious={'Class2x4x8'} //link to previous screen
...
export default Class2x4x9 //name for export
