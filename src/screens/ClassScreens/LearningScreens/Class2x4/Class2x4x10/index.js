...
const answerOne = 'jeg kan hjelp meg';  //answer a
const answerTwo = 'kunne jeg hjelpe ham'; //answer b
const answerThree = 'han kunne hjelpe meg'; //answer c
const answerFour = 'jeg kunne hjelpe ham'; //answer d
const correctAnswers = [false, false, false, true];  //correct answer true or false


const Class2x4x10 = ({route}) => {  //name
  ...
  return (
    <View style={styles.mainContainer}>
        ...
        <View style={styles.bottomBarContainer}>
          ...
          linkNext={'Class2x4x11'}  //link to next screen
          linkPrevious={'Class2x4x9'} //link to previous screen
          correctMsg={'Sensational!'} //correct msg
...
export default Class2x4x10 //name for export
