...
const answerOne = 'arbeid';  //answer a
const answerTwo = 'vindu'; //answer b
const answerThree = 'sukker'; //answer c
const answerFour = 'kaffe'; //answer d
const correctAnswers = [true, false, true, true];  //correct answer true or false


const Class4x3x5 = ({route}) => {  //name
    ...
    <View style={styles.mainContainer}>
        <ScrollView showsVerticalScrollIndicator={false} style={styles.body}>
            ...
            <View style={styles.topView}>
                <Text style={styles.questionText}>Pick all nouns that are uncountable.</Text>
        ...
        <View style={styles.bottomBarContainer}>
          ...
          linkNext={'Class4x3x6'}  //link to next screen
          linkPrevious={'Class4x3x4'} //link to previous screen
          correctMsg={'Keep up the good work'} //correct msg
          wrongMsg={'There are three correct answers'} //wrong msg
...
export default Class4x3x5 //name for export
