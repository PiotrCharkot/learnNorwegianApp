...
const correctAnswers = ['Jeg', 'har', 'mye jobb']; // array with correct words in line up to the word that goes in gap. exapmle ==> const correctAnswers = ['Jeg', 'trenger'];

const indexOfGaps = [2] // array with index of a gap in text
const indexOfText = [0, 1, 3] // array with indexes of text

const Class4x3x6 = ({ route }) => {  //screen name
    ...
    const [words, setWords] = useState(['Jeg', 'har' ,'            ', 'i dag.','!!!' ,'litt jobb' , 'mye jobb', 'mange jobb' ]); // arr with word in order, after '!!!' comes word to choose from Jeg har mye jobb i dag.
      ...
      <ProgressBar screenNum={currentScreen} totalLenghtNum={allScreensNum} latestScreen={latestScreenDone} comeBack={comeBackRoute}/>
        <View style={styles.body}>
            ...
            <View style={styles.topView}>
                ...
                <Text style={styles.textBody}>(I have a lot of work today.)</Text>
            </View>
        ...
        <View style={styles.bottomBarContainer}>
          ...
          linkNext={'Class4x3x7'} //link to next screen
          linkPrevious={'Class4x3x5'} //link to previous screen
...
export default Class4x3x6 //name for export
