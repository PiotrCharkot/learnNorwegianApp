...
const Class7x5x7 = ({route}) => { //name for component
    ...
    <View style={styles.mainContainer}>
        <ScrollView showsVerticalScrollIndicator={false} style={styles.body}>
          ...
          <View style={styles.textContainer}>
              <Text style={styles.text}>Commands or exclamatory sentences also tend to have rising intonation at the end.</Text>
          </View>
          ...
          <TouchableOpacity onPress={() => {playSound(soundA)}}>
            <View style={styles.exampleContainer}>
                ...
                <Text style={styles.exampleText}><Text style={styles.exampleText}>Kom hit!</Text></Text>
          ...
          <TouchableOpacity onPress={() => {playSound(soundB)}}>
            <View style={styles.exampleContainer}>
                <Image style={styles.pictureSoundInContainer} source={require('../../../../../../assets/volume.png')} />
                <Text style={styles.exampleText}><Text style={styles.exampleText}>Slutt med det!</Text></Text>
                <Text style={styles.exampleTextTrans}>-----------¯¯¯¯</Text>
            </View>
          </TouchableOpacity>
          ...
          <TouchableOpacity onPress={() => {playSound(soundC)}}>
            <View style={styles.exampleContainer}>
                <Image style={styles.pictureSoundInContainer} source={require('../../../../../../assets/volume.png')} />
                <Text style={styles.exampleText}><Text style={styles.exampleText}>For en fantastisk dag!</Text></Text>
                <Text style={styles.exampleTextTrans}>-------------------¯¯¯¯</Text>
            </View>
          </TouchableOpacity>
        ...
        <View style={styles.bottomBarContainer}>
          ...
          linkNext={'Class7x5x8'} //link next
          linkPrevious={'Class7x5x6'} //link previous
...
export default Class7x5x7 //name for export
