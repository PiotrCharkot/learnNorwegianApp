...
const Class7x5x3 = ({route}) => { //name for component
    ...
    <View style={styles.mainContainer}>
        <ScrollView showsVerticalScrollIndicator={false} style={styles.body}>
          ...
          <View style={styles.textContainer}>
              <Text style={styles.text}>In some cases stress doesn't fall on the first syllable. {'\n\n'}Many loanwords keep a later-syllable stress, especially if that’s how they’re stressed in the source language or if they contain certain suffixes (-sjon, -ere).</Text>
          </View>
          ...
          <TouchableOpacity onPress={() => {playSound(soundA)}}>
            <View style={styles.exampleContainer}>
                ...
                <Text style={styles.exampleText}>mu<Text style={styles.exampleTextUnderline}>sikk</Text> - <Text style={styles.exampleTextTrans}>/musi´k:/</Text></Text>
                <Text style={styles.exampleTextTrans}>music</Text>
            </View>
          </TouchableOpacity>
          ...
          <TouchableOpacity onPress={() => {playSound(soundB)}}>
            <View style={styles.exampleContainer}>
                <Image style={styles.pictureSoundInContainer} source={require('../../../../../../assets/volume.png')} />
                <Text style={styles.exampleText}>informa<Text style={styles.exampleTextUnderline}>sjon</Text> - <Text style={styles.exampleTextTrans}>/ɪnfuːrmɑˈʃuːn/</Text></Text>
                <Text style={styles.exampleTextTrans}>information</Text>
            </View>
          </TouchableOpacity>
          ...
          <TouchableOpacity onPress={() => {playSound(soundC)}}>
            <View style={styles.exampleContainer}>
                <Image style={styles.pictureSoundInContainer} source={require('../../../../../../assets/volume.png')} />
                <Text style={styles.exampleText}>doku<Text style={styles.exampleTextUnderline}>ment</Text> - <Text style={styles.exampleTextTrans}>/dokume´nt/</Text></Text>
                <Text style={styles.exampleTextTrans}>dokument</Text>
            </View>
          </TouchableOpacity>
        ...
        <View style={styles.bottomBarContainer}>
          ...
          linkNext={'Class7x5x4'} //link next
          linkPrevious={'Class7x5x2'} //link previous
...
export default Class7x5x3 //name for export
