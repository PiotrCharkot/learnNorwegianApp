    ...
    <View style={styles.mainContainer}>
        <ScrollView showsVerticalScrollIndicator={false} style={styles.body}>
          <View style={styles.topView}>
            <Text style={styles.title}>Stress and Intonation - Stress og intonasjon</Text>
          </View>
        ...
        <View style={styles.bottomBarContainer}>
          <BottomBar 
          linkNext={'Class7x5x2'} //link to next screen
...
export default Class7x5x1 // name for export
