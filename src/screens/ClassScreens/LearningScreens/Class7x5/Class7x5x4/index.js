...
const Class7x5x4 = ({route}) => { //name for component
    ...
    <View style={styles.mainContainer}>
        <ScrollView showsVerticalScrollIndicator={false} style={styles.body}>
          ...
          <View style={styles.textContainer}>
              <Text style={styles.text}>In compound words, stress typically falls on the first part of the word.</Text>
          </View>
          ...
          <TouchableOpacity onPress={() => {playSound(soundA)}}>
            <View style={styles.exampleContainer}>
                ...
                <Text style={styles.exampleText}><Text style={styles.exampleTextUnderline}>tann</Text>lege - <Text style={styles.exampleTextTrans}>/tɑnː´leːɡə/</Text></Text>
                <Text style={styles.exampleTextTrans}>dentist</Text>
            </View>
          </TouchableOpacity>
          ...
          <TouchableOpacity onPress={() => {playSound(soundB)}}>
            <View style={styles.exampleContainer}>
                <Image style={styles.pictureSoundInContainer} source={require('../../../../../../assets/volume.png')} />
                <Text style={styles.exampleText}><Text style={styles.exampleTextUnderline}>brann</Text>bil - <Text style={styles.exampleTextTrans}>/brɑnː´biːl/</Text></Text>
                <Text style={styles.exampleTextTrans}>fire truck</Text>
            </View>
          </TouchableOpacity>
          ...
          <TouchableOpacity onPress={() => {playSound(soundC)}}>
            <View style={styles.exampleContainer}>
                <Image style={styles.pictureSoundInContainer} source={require('../../../../../../assets/volume.png')} />
                <Text style={styles.exampleText}><Text style={styles.exampleTextUnderline}>sy</Text>kehus - <Text style={styles.exampleTextTrans}>/syː´kəhʉːs/</Text></Text>
                <Text style={styles.exampleTextTrans}>hospital</Text>
            </View>
          </TouchableOpacity>
        ...
        <View style={styles.bottomBarContainer}>
          ...
          linkNext={'Class7x5x5'} //link next
          linkPrevious={'Class7x5x3'} //link previous
...
export default Class7x5x4 //name for export
