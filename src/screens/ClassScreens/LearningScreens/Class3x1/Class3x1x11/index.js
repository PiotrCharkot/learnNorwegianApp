...
const answerOne = 'kan';  //answer a
const answerTwo = 'må'; //answer b
const answerThree = 'vil'; //answer c
const answerFour = 'bør'; //answer d
    ...
    <View style={styles.mainContainer}>
        <ScrollView showsVerticalScrollIndicator={false} style={styles.body}>
            ...
            <View style={styles.topView}>
                <Text style={styles.questionText}>Choose correct answer. Form a sentence that is offering advice.</Text>
                <Text style={styles.textBody}>Du ___ spise mer grønnsaker.</Text>
                <Text style={styles.textBody}>(You should eat more vegetables.)</Text>
            </View>
        ...
        <View style={styles.bottomBarContainer}>
          ...
          linkPrevious={'Class3x1x10'} //link to previous screen
          correctMsg={`I'm impressed${user.isAnonymous ? '':  ` ${user.displayName}`}!`} //correct msg
...
export default Class3x1x11 //name for export
