...
const correctAnswers = ['Jeg', 'ville']; // array with correct words in line up to the word that goes in gap. exapmle ==> const correctAnswers = ['Jeg', 'trenger'];

const indexOfGaps = [1] // array with index of a gap in text
const indexOfText = [0, 2, 3, 4, 5, 6, 7, 8, 9] // array with indexes of text
...
const Class3x1x10 = ({ route }) => {  //screen name
    ...
    const [words, setWords] = useState(['Jeg' ,'            ', 'kjøpe', 'den',  'nye', 'boken,', 'men', 'den' ,'var' ,'utsolgt.', '!!!' , 'vil', 'burde' ,'kunne' ,'ville']); // arr with word in order, after '!!!' comes word to choose from Jeg ville kjøpe den nye boken, men den var utsolgt.
      ...
      <ProgressBar screenNum={currentScreen} totalLenghtNum={allScreensNum} latestScreen={latestScreenDone} comeBack={comeBackRoute}/>
        <View style={styles.body}>
            ...
            <View style={styles.topView}>
                <Text style={styles.questionText}>Form the sentence in the past tense. Drag the correct answer into the gap.</Text>
                <Text style={styles.textBody}>(I would buy the new book, but it was sold out.)</Text>
            </View>
        ...
        <View style={styles.bottomBarContainer}>
          ...
          linkNext={'Class3x1x11'} //link to next screen
          linkPrevious={'Class3x1x9'} //link to previous screen
          correctMsg={'I knew you could do it.'} //correct msg
          wrongMsg={`Oopsie, Let's look at it again.`} //wrong msg
...
export default Class3x1x10 //name for export
