...
const Class3x1x9 = ({ route }) => { // name
    ...
    const [words, setWords] = useState(['gå', 'må', 'hjem', 'Jeg', 'nå'],); // words to sort in random order Jeg må gå hjem nå
    ...
    <View style={styles.mainContainer}>
      ...
      <View style={styles.body}>
          ...
          <View style={styles.topView}>
              ...
              <Text style={styles.textBody}>(I must go home now.)</Text>
          </View>
      ...
      <View style={styles.bottomBarContainer}>
        ...
        linkNext={'Class3x1x10'} //link next screen 
        linkPrevious={'Class3x1x8'} //link previous screen
...
export default Class3x1x9 //name export
