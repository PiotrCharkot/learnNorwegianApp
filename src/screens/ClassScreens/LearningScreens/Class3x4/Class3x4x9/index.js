...
const answerOne = 'fantes';  //answer a
const answerTwo = 'møttes'; //answer b
const answerThree = 'synes'; //answer c
    ...
    <View style={styles.mainContainer}>
        <ScrollView showsVerticalScrollIndicator={false} style={styles.body}>
            ...
            <View style={styles.topView}>
                ...
                <Text style={styles.textBody}>Vi ______ i parken i går.</Text>
            </View>
        ...
        <View style={styles.bottomBarContainer}>
          ...
          linkPrevious={'Class3x4x8'} //link to previous screen
          correctMsg={'Good job! Keep it up!'} //correct msg
...
export default Class3x4x9 //name for export
