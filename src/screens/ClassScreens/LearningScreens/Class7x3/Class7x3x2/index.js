...
const Class7x3x2 = ({route}) => { //name for component
    ...
    <View style={styles.mainContainer}>
        <ScrollView showsVerticalScrollIndicator={false} style={styles.body}>
          ...
          <View style={styles.textContainer}>
              <Text style={styles.text}>First cluster is "<Text style={styles.textColor}>kj</Text>" A soft, hissing sound, like the German "ich".</Text>
          </View>
          ...
          <TouchableOpacity onPress={() => {playSound(soundA)}}>
            <View style={styles.exampleContainer}>
                ...
                <Text style={styles.exampleText}>kj</Text>
            </View>
          </TouchableOpacity>
          ...
          <TouchableOpacity onPress={() => {playSound(soundB)}}>
            <View style={styles.exampleContainer}>
                <Image style={styles.pictureSoundInContainer} source={require('../../../../../../assets/volume.png')} />
                <Text style={styles.exampleText}><Text style={styles.exampleTextColor}>kj</Text>ære - <Text style={styles.exampleTextTrans}>/çæːrə/</Text></Text>
                <Text style={styles.exampleTextTrans}>dear</Text>
            </View>
          </TouchableOpacity>
          ...
          <TouchableOpacity onPress={() => {playSound(soundC)}}>
            <View style={styles.exampleContainer}>
                <Image style={styles.pictureSoundInContainer} source={require('../../../../../../assets/volume.png')} />
                <Text style={styles.exampleText}><Text style={styles.exampleTextColor}>kj</Text>empe - <Text style={styles.exampleTextTrans}>/çɛmpə/</Text></Text>
                <Text style={styles.exampleTextTrans}>great</Text>
            </View>
          </TouchableOpacity>
          ...
          <View style={styles.textContainer}>
          <Text style={styles.text}><Text style={styles.boldText}>Tips:</Text> {'\n'}- position middle/front of your tongue close to the roof of your mouth without touching it {'\n'}- lips are relaxed and slightly spread. Avoid rounding your lips too much</Text>
          </View>
        ...
        <View style={styles.bottomBarContainer}>
          ...
          linkNext={'Class7x3x3'} //link next
          linkPrevious={'Class7x3x1'} //link previous
...
export default Class7x3x2 //name for export
