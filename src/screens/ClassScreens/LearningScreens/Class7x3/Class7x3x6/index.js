...
const Class7x3x6 = ({route}) => { //name for component
    ...
    <View style={styles.mainContainer}>
        <ScrollView showsVerticalScrollIndicator={false} style={styles.body}>
          ...
          <View style={styles.textContainer}>
              <Text style={styles.text}>When "<Text style={styles.textColor}>g</Text>" is followed by j or the vowels i or y it is pronounced soft [j]. It's also pronounced soft at the end of pronouns like "jeg", "deg", "meg" or "seg".</Text> 
          </View>
          ...
          <TouchableOpacity onPress={() => {playSound(soundA)}}>
            <View style={styles.exampleContainer}>
                ...
                <Text style={styles.exampleText}>å <Text style={styles.exampleTextColor}>gj</Text>øre - <Text style={styles.exampleTextTrans}>/jøːrə/</Text></Text>
                <Text style={styles.exampleTextTrans}>to do</Text>
            </View>
          </TouchableOpacity>
          ...
          <TouchableOpacity onPress={() => {playSound(soundB)}}>
            <View style={styles.exampleContainer}>
                <Image style={styles.pictureSoundInContainer} source={require('../../../../../../assets/volume.png')} />
                <Text style={styles.exampleText}>å <Text style={styles.exampleTextColor}>gi</Text> - <Text style={styles.exampleTextTrans}>/jiː/</Text></Text>
                <Text style={styles.exampleTextTrans}>to give</Text>
            </View>
          </TouchableOpacity>


          <View style={styles.textContainer}>
              <Text style={styles.text}>When it is followed by other vowels or consonants, "<Text style={styles.textColor}>g</Text>" is pronounced as the hard [g].</Text>
          </View>
          ...
          <TouchableOpacity onPress={() => {playSound(soundC)}}>
            <View style={styles.exampleContainer}>
                ...
                <Text style={styles.exampleText}><Text style={styles.exampleTextColor}>g</Text>od  - <Text style={styles.exampleTextTrans}>/guː/</Text></Text>
                <Text style={styles.exampleTextTrans}>good</Text>
            </View>
          </TouchableOpacity>
        ...
        <View style={styles.bottomBarContainer}>
          ...
          linkNext={'Class7x3x7'} //link next
          linkPrevious={'Class7x3x5'} //link previous
...
export default Class7x3x6 //name for export
