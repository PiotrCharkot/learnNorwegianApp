    ...
    <View style={styles.mainContainer}>
        <ScrollView showsVerticalScrollIndicator={false} style={styles.body}>
          ...
          <View style={styles.middleView}>
            ...
            <Text style={styles.text}><Text style={styles.textColor}>Compound words</Text> (<Text style={styles.textColor}>samskriving</Text>) is the process of combining noun with another word to create a new word. {'\n\n'}This is a common feature of Norwegian language, and <Text style={styles.textColor}>compound words</Text> often express a more specific meaning than their individual parts. {'\n\n'}<Text style={styles.textColor}>Compound words</Text> can be formed by combining different word classes, such as nouns, adjectives, verbs, and adverbs. {'\n\n'}The first word usually modifies or describes the second word.
            </Text>
        ...
        <View style={styles.bottomBarContainer}>
          <BottomBar 
          linkNext={'Class4x6x2'} //link to next screen
...
export default Class4x6x1 // name for export
