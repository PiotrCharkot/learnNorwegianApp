...
const answerOne = 'håndtak';  //answer a
const answerTwo = 'håndkle'; //answer b
const answerThree = 'håndverk'; //answer c
const answerFour = 'håndskrift'; //answer d
    ...
    <View style={styles.mainContainer}>
        <ScrollView showsVerticalScrollIndicator={false} style={styles.body}>
            ...
            <View style={styles.topView}>
                <Text style={styles.questionText}>Choose word that describes 'towel'.</Text>
            </View>
        ...
        <View style={styles.bottomBarContainer}>
            ...
            linkPrevious={'Class4x6x8'} //link to previous screen
...
export default Class4x6x9 //name for export
