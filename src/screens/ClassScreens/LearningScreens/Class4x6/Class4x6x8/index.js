...
const answerOne = 'verktøyskap';  //answer a
const answerTwo = 'garderobeskap'; //answer b
const answerThree = 'medisinskap'; //answer c
const answerFour = 'kjøleskap'; //answer d
const correctAnswers = [false, false, false, true];  //correct answer true or false


const Class4x6x8 = ({route}) => {  //name
    ...
    <View style={styles.mainContainer}>
        <ScrollView showsVerticalScrollIndicator={false} style={styles.body}>
            ...
            <View style={styles.topView}>
                <Text style={styles.questionText}>Choose word that describes 'refrigerator'.</Text>
            </View>
        ...
        <View style={styles.bottomBarContainer}>
          ...
          linkNext={'Class4x6x9'}  //link to next screen
          linkPrevious={'Class4x6x7'} //link to previous screen
...
export default Class4x6x8 //name for export
