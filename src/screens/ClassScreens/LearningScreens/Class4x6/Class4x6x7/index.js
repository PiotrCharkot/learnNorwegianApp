...
const answerOne = 'arbeidstid';  //answer a
const answerTwo = 'arbeidsplassen'; //answer b
const answerThree = 'arbeidsledighet'; //answer c
const answerFour = 'arbeidsgiver'; //answer d
const correctAnswers = [false, false, true, false];  //correct answer true or false


const Class4x6x7 = ({route}) => {  //name
    ...
    <View style={styles.mainContainer}>
        <ScrollView showsVerticalScrollIndicator={false} style={styles.body}>
            ...
            <View style={styles.topView}>
                <Text style={styles.questionText}>Choose word that describes 'unemployment'.</Text>
            </View>
        ...
        <View style={styles.bottomBarContainer}>
          ...
          linkNext={'Class4x6x8'}  //link to next screen
          linkPrevious={'Class4x6x6'} //link to previous screen
...
export default Class4x6x7 //name for export
