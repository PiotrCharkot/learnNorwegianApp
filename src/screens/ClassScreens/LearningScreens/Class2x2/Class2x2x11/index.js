...
const wordsCorrect = [  // words in correct orders
    [
        ['Hvordan', 'kommer', 'jeg', 'til', 'stasjonen', '?']
    ]
]

const Class2x2x11 = ({ route }) => { // name
  ...
  return (
    <View style={styles.mainContainer}>
      <ProgressBar screenNum={currentScreen} totalLenghtNum={allScreensNum} latestScreen={latestScreenDone} comeBack={comeBackRoute}/>
        <View style={styles.body}>
            ...
            <View style={styles.topView}>
                <Text style={styles.questionText}>Sort these words to create a question.</Text>
                <Text style={styles.textBody}>(How do I get to the station?)</Text>
            </View>
      ...
      <View style={styles.bottomBarContainer}>
        ...
        linkPrevious={'Class2x2x10'} //link previous screen
        correctMsg={`You’re learning fast!`} //correct msg
        wrongMsg={`It should be 'Hvordan kommer jeg...'`} //wrong msg
...
export default Class2x2x11 //name export
