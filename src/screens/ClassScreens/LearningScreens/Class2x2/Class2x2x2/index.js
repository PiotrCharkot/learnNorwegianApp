    ...
    <View style={styles.mainContainer}>
        <ScrollView showsVerticalScrollIndicator={false} style={styles.body}>
          ...
          <View style={styles.textContainer}>
            <Text style={styles.text}>Let's dive into a couple of examples to make it crystal clear:</Text>
          </View>

          

          <View style={styles.exampleContainer}>
          <Text style={{...styles.exampleText, color: '#6441A5', fontSize: 18, marginBottom: 10}}>Spiser hun epler?</Text>
            <Text style={styles.exampleText}>Verb</Text>
            <Text style={styles.text}>Spiser (eat)</Text>
          ...
          <View style={styles.exampleContainer}>
          <Text style={{...styles.exampleText, color: '#6441A5', fontSize: 18, marginBottom: 10}}>Reiser de til Spania?</Text>
            <Text style={styles.exampleText}>Verb</Text>
        ...
        <View style={styles.bottomBarContainer}>
          <BottomBar 
          linkNext={'Class2x2x3'} //link next screen 
          linkPrevious={'Class2x2x1'} // link previous screen
...
export default Class2x2x2 //name export 
