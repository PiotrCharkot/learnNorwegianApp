...
const wordsCorrect = [  // words in correct orders
    [
        ['Vi', 'kan', 'ikke', 'hjelpe', 'deg', 'i dag'],
        ['i dag', 'kan', 'Vi', 'ikke', 'hjelpe', 'deg'],
        ['deg', 'kan', 'Vi', 'ikke', 'hjelpe', 'i dag'],
    ]
]

const Class2x2x10 = ({ route }) => { // name
    ...
    const [words, setWords] = useState(['hjelpe', 'i dag', 'kan', 'Vi', 'deg', 'ikke',]); // words to sort in random order Vi kan ikke hjelpe deg i dag.
  ...
  return (
    <View style={styles.mainContainer}>
      <ProgressBar screenNum={currentScreen} totalLenghtNum={allScreensNum} latestScreen={latestScreenDone} comeBack={comeBackRoute}/>
        <View style={styles.body}>
            ...
            <View style={styles.topView}>
                <Text style={styles.questionText}>Rearrange the words to create a negative sentence.</Text>
                <Text style={styles.textBody}>(We can't help you today.)</Text>
            </View>
      ...
      <View style={styles.bottomBarContainer}>
        ...
        linkNext={'Class2x2x11'} //link next screen 
        linkPrevious={'Class2x2x9'} //link previous screen
        correctMsg={`You’ve got it made!`} //correct msg
        wrongMsg={`Vi kan ikke...`} //wrong msg
...
export default Class2x2x10 //name export
