...
const Class2x2x9 = ({ route }) => { // name
    ...
    const [words, setWords] = useState(['i morgen', 'du', 'festen', 'på', 'Kommer', '?' ]); // words to sort in random order Kommer du på festen i morgen?
  ...
  return (
    <View style={styles.mainContainer}>
      <ProgressBar screenNum={currentScreen} totalLenghtNum={allScreensNum} latestScreen={latestScreenDone} comeBack={comeBackRoute}/>
        <View style={styles.body}>
            ...
            <View style={styles.topView}>
                <Text style={styles.questionText}>Arrange the words in the sentence to form a question.</Text>
                <Text style={styles.textBody}>(Are you coming to the party tomorrow?)</Text>
            </View>
      ...
      <View style={styles.bottomBarContainer}>
        ...
        linkNext={'Class2x2x10'} //link next screen 
        linkPrevious={'Class2x2x8'} //link previous screen
        correctMsg={`Now that’s what I call a fine job!`} //correct msg
...
export default Class2x2x9 //name export
