    ...
    <View style={styles.mainContainer}>
        <ScrollView showsVerticalScrollIndicator={false} style={styles.body}>
          ...
          <View style={styles.exampleContainer}>
            <Text style={styles.exampleTextSmall}>Det er kaldt i dag, <Text style={styles.exampleTextSmallColor}>ikke sant</Text>?</Text>
            <Text style={styles.textSmall}>It's cold today, isn't it?</Text>
          </View>

          <View style={styles.exampleContainer}>
            <Text style={styles.exampleTextSmall}>- Det var en flott film!</Text>
            <Text style={styles.exampleTextSmall}><Text style={styles.exampleTextSmallColor}>- Ikke sant</Text>?</Text>
            <Text style={styles.textSmall}>- That was a great movie!</Text>
