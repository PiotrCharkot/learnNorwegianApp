...
const answerTwo = 'dere'; //answer b
const answerThree = 'meg'; //answer c
const answerFour = 'oss'; //answer d
    ...
    <View style={styles.mainContainer}>
        <ScrollView showsVerticalScrollIndicator={false} style={styles.body}>
            ...
            <View style={styles.topView}>
                ...
                <Text style={styles.textBody}>Vi gleder ____ til ferien.</Text>
            </View>
        ...
        <View style={styles.bottomBarContainer}>
          ...
          linkNext={'Class6x6x6'}  //link to next screen
          linkPrevious={'Class6x6x4'} //link to previous screen
...
export default Class6x6x5 //name for export
