    ...
    <View style={styles.mainContainer}>
        <ScrollView showsVerticalScrollIndicator={false} style={styles.body}>
          <View style={styles.topView}>
            <Text style={styles.title}>Reflexive pronouns - Refleksive pronomen</Text>
          </View>
          ...
          <View style={styles.middleView}>
            ...
            <Text style={styles.text}>Let's talk about <Text style={styles.textColor}>reflexive pronouns</Text> (refleksive pronomen). They are used when the subject and object of a verb are the same person or thing. {'\n\n'}These pronouns help to indicate that the action of the verb is directed back to the subject. (e.g. 'I wash myslef.' or 'He teaches himself.') {'\n\n'}Let's jump into some examples to see them in action!
            </Text>
        ...
        <View style={styles.bottomBarContainer}>
          <BottomBar 
          linkNext={'Class6x6x2'} //link to next screen
...
export default Class6x6x1 // name for export
