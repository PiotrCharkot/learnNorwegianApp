...
const correctAnswers = ['Han', 'har', 'glemt', 'passet' ,'sitt']; // array with correct words in line up to the word that goes in gap. exapmle ==> const correctAnswers = ['Jeg', 'trenger'];

const indexOfGaps = [4] // array with index of a gap in text
const indexOfText = [0, 1, 2, 3, 5, 6] // array with indexes of text
...
const Class4x4x10 = ({ route }) => {  //screen name
    ...
    const [words, setWords] = useState(['Han', 'har', 'glemt', 'passet' ,'            ', 'på', 'bussen.','!!!' , 'sin', 'sitt' ,'sine']); // arr with word in order, after '!!!' comes word to choose from Han har glemt passet sitt på bussen.
      ...
      <ProgressBar screenNum={currentScreen} totalLenghtNum={allScreensNum} latestScreen={latestScreenDone} comeBack={comeBackRoute}/>
        <View style={styles.body}>
            ...
            <View style={styles.topView}>
                ...
                <Text style={styles.textBody}>He has forgotten his passport on the bus.</Text>
            </View>
        ...
        <View style={styles.bottomBarContainer}>
          ...
          linkPrevious={'Class4x4x9'} //link to previous screen
          correctMsg={'Impressive...'} //correct msg
          wrongMsg={`passet - et pass - neuter singular noun`} //wrong msg
...
export default Class4x4x10 //name for export
