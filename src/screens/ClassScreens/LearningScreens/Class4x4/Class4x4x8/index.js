...
const answerOne = 'brorens bok';  //answer a
const answerTwo = 'broren boks'; //answer b
const answerThree = 'brorens boken sin'; //answer c
const answerFour = ' brorens boken'; //answer d
const correctAnswers = [true, false, false, false];  //correct answer true or false


const Class4x4x8 = ({route}) => {  //name
    ...
    <View style={styles.mainContainer}>
        <ScrollView showsVerticalScrollIndicator={false} style={styles.body}>
            ...
            <View style={styles.topView}>
                <Text style={styles.questionText}>Choose correct form to fill gap in the sentence.</Text>
                <Text style={styles.textBody}>Jeg leser __________.</Text>
            </View>
        ...
        <View style={styles.bottomBarContainer}>
          ...
          linkNext={'Class4x4x9'}  //link to next screen
          linkPrevious={'Class4x4x7'} //link to previous screen
...
export default Class4x4x8 //name for export
