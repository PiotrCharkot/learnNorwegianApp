...
const Class4x4x9 = ({ route }) => { // name
    ...
    const [words, setWords] = useState(['interessant', 'Maria',  'veldig',  'Boken', 'er', 'til',]); // words to sort in random order Boken til Maria er veldig interessant.
    ...
    <View style={styles.mainContainer}>
      ...
      <View style={styles.body}>
          ...
          <View style={styles.topView}>
              ...
              <Text style={styles.textBody}>Maria's book is very interesting.</Text>
          </View>
      ...
      <View style={styles.bottomBarContainer}>
        ...
        linkNext={'Class4x4x10'} //link next screen 
        linkPrevious={'Class4x4x8'} //link previous screen
        correctMsg={`That’s the right way to do it.`} //correct msg
        wrongMsg={'Boken til Maria er...'} //wrong msg
...
export default Class4x4x9 //name export
