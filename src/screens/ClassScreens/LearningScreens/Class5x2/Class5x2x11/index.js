...
const answerOne = 'Store';  //answer a
const answerTwo = 'Stort'; //answer b
const answerThree = 'Stor'; //answer c
const answerFour = 'De store'; //answer d
const correctAnswers = [true, false, false, false];  //correct answer true or false


const Class5x2x11 = ({route}) => {  //name
    ...
    <View style={styles.mainContainer}>
        <ScrollView showsVerticalScrollIndicator={false} style={styles.body}>
            ...
            <View style={styles.topView}>
                <Text style={styles.questionText}>Choose right form for adjective 'big' in this sentence.</Text>
                <Text style={styles.textBody}>_____ drømmer krever hardt arbeid.</Text>
                <Text style={styles.textBody}>Big dreams require hard work.</Text>
            </View>
        ...
        <View style={styles.bottomBarContainer}>
          ...
          linkNext={'Class5x2x12'}  //link to next screen
          linkPrevious={'Class5x2x10'} //link to previous screen
...
export default Class5x2x11 //name for export
