    ...
    <View style={styles.mainContainer}>
        <ScrollView showsVerticalScrollIndicator={false} style={styles.body}>
          <View style={styles.topView}>
            <Text style={styles.title}>Agreement - Kongruens</Text>
          </View>
          ...
          <View style={styles.middleView}>
            ...
            <Text style={styles.text}>In Norwegian, <Text style={styles.textColor}>agreement</Text> (<Text style={styles.textColor}>kongruens</Text>) refers to the phenomenon where certain elements of a sentence, such as nouns, pronouns, adjectives, and verbs, need to "agree" with each other in terms of gender, number, or person. {'\n\n'}This means that the form of one word may change depending on the form of another word in the same sentence. {'\n\n'}Let's have a look at some examples of <Text style={styles.textColor}>agreement</Text> in Norwegian.
            </Text>
        ...
        <View style={styles.bottomBarContainer}>
          <BottomBar 
          linkNext={'Class5x2x2'} //link to next screen
...
export default Class5x2x1 // name for export
