...
const wordsCorrect = [  // words in correct orders ==> Selv om jeg er trøtt, skal jeg fortsette å jobbe.
    [
        ['Selv om', 'jeg', 'er', 'trøtt', 'skal', 'jeg', 'fortsette', 'å', 'jobbe']
    ]
]

const Class2x3x11 = ({ route }) => { // name
    ...
    const [words, setWords] = useState(['å', 'fortsette', 'jeg', 'skal', 'jeg', 'er', 'trøtt', 'jobbe', 'Selv om']); // words to sort in random order
      ...
      <ProgressBar screenNum={currentScreen} totalLenghtNum={allScreensNum} latestScreen={latestScreenDone} comeBack={comeBackRoute}/>
        <View style={styles.body}>
            ...
            <View style={styles.topView}>
                <Text style={styles.questionText}>Arrange the words so that the sentence starts with a subordinate clause.</Text>
                <Text style={styles.textBody}>Jeg skal fortsette å jobbe selv om jeg er trøtt.</Text>
                <Text style={styles.textBody}>(I will continue to work even if I am tired.)</Text>
            </View>
        ...
        <View style={styles.bottomBarContainer}>
            ...
            linkNext={'Class2x3x12'} //link next screen 
            linkPrevious={'Class2x3x10'} //link previous screen
            correctMsg={`Way to go${user.isAnonymous ? '':  ` ${user.displayName}`}!`} //correct msg
            wrongMsg={'Selv om jeg er trøtt, skal jeg...'} //wrong msg
...
export default Class2x3x11 //name export
