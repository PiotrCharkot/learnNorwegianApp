import type1data from '../../listData/dataExercise/forTesting/Type1';
import type2data from '../../listData/dataExercise/forTesting/Type2';
import type3data from '../../listData/dataExercise/forTesting/Type3';
import type4data from '../../listData/dataExercise/forTesting/Type4';
import type5data from '../../listData/dataExercise/forTesting/Type5';
import type6data from '../../listData/dataExercise/forTesting/Type6';
import type7data from '../../listData/dataExercise/forTesting/Type7';
import type8data from '../../listData/dataExercise/forTesting/Type8';
...
const TestingOpeningScreen = ({route}) => {
  ...
  useEffect(() => {
    ...
    let type1dataNew = type1data;
    let type2dataNew = type2data;
    let type3dataNew = type3data;
    let type4dataNew = type4data;
    let type5dataNew = type5data;
    let type6dataNew = type6data;
...
export default TestingOpeningScreen
