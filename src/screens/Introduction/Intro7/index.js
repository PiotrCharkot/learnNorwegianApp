  ...
  return (
    <Animated.View style={{...styles.mainContainer, backgroundColor: backgroundColorInterpolate}}>
        ...
        <Animated.View style={styles.profilImgContainer}>
            <Animated.Image source={require('../../../../assets/profilImg.png')} style={{...styles.profilImg, opacity: opacityProfilImg}}/>
        </Animated.View>
        

        <Animated.View style={styles.settingsImgContainer}>
            <Animated.Image source={require('../../../../assets/settingsImg.png')} style={{...styles.settingsImg, opacity: opacitySettingsImg}}/>
        </Animated.View>
        ...
        <Animated.View style={{...styles.barImgContainer, transform: [{translateY: barPosition}]}}>
            ...
            <Animated.Image source={require('../../../../assets/bar-profil.png')} style={{...styles.barImg, opacity: opacityBar2}}/>
        </Animated.View>
        ...
        <Animated.View style={{...styles.buttonContainer, opacity: opacityNextBtn, transform: [{translateX: xPosNextBtn}]}}>
            <TouchableOpacity onPress={() => navigation.replace("Intro8")}>
