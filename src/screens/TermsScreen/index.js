...
<Text style={styles.subtitleText}>Last updated: 06.22.2024</Text>{'\n\n'}
...
All rights, title, and interest in and to <Text style={styles.textCursive}>Learn Norwegian</Text> (including any and all intellectual property) are and will remain the exclusive property of <Text style={styles.textCursive}>Norsk Navigator</Text> and its licensors. The terms do not grant you any rights to use any branding or logos used in our Services.{'\n\n\n'}
...
If you have any questions about these Terms, please contact us at: <Text style={styles.textCursive}>support@learnnorwegianapp.com</Text>{'\n\n\n\n\n\n'}</Text>
            </ScrollView>
        </View>
    )
}
