...
//     },
    ...
    },
    {
        ...
        translations: {
            ...
            ar: ['تم تدقيق التقرير', 'تم نشر الدرس على الإنترنت', 'تم إطلاق الفيلم العام الماضي', 'تم نشر الكتاب لأول مرة في عام 1984'],
            ger: ['Der Bericht wurde geprüft', 'Die Lektion wurde online veröffentlicht', 'Der Film wurde letztes Jahr gestartet', 'Das Buch wurde erstmals 1984 veröffentlicht'],
            lt: ['Ataskaita buvo peržiūrėta', 'Pamoka buvo paskelbta internete', 'Filmas buvo pristatytas praėjusiais metais', 'Knyga buvo išleista pirmą kartą 1984 m.'],
            ua: ['Звіт було перевірено', 'Урок було опубліковано в інтернеті', 'Фільм було запущено в минулому році', 'Книгу було видано вперше у 1984 році'],
            sp: ['El informe fue auditado', 'La lección fue publicada en línea', 'La película fue lanzada el año pasado', 'El libro fue publicado por primera vez en 1984'],
        },
            instructions: {
                eng: ['Enter the correct form in the passive voice. Use \'å bli\'.'],
                pl: ['Wpisz poprawną formę w stronie biernej. Użyj \'å bli\'.'],
                ar: ['أدخل الصيغة الصحيحة في المبني للمجهول. استخدم \'å bli\'.'],
                ger: ['Gib die richtige Form im Passiv ein. Verwende \'å bli\'.'],
                lt: ['Įveskite teisingą formą neveikiamajame rūpyje. Naudokite \'å bli\'.'],
                ua: ['Введіть правильну форму в пасивному стані. Використовуйте \'å bli\'.'],
                sp: ['Introduce la forma correcta en voz pasiva. Usa \'å bli\'.'],
            }
    },
