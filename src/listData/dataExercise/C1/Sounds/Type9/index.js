export default dataObj = [
    {
        ...
        textIndex: [],
        translations: {
            eng: 'I had already left the office when you called.',
            pl: 'Już opuściłem biuro, gdy zadzwoniłeś.',
            lt: 'Aš jau buvau palikęs biurą, kai tu paskambinai.',
            ar: 'كنت قد غادرت المكتب بالفعل عندما اتصلت.',
            ua: 'Я вже покинув офіс, коли ти зателефонував.',
    ...
    },
    {
        ...
        textIndex: [],
        translations: {
            eng: 'She had been studying for several hours before she took a break.',
            pl: 'Studiowała przez kilka godzin, zanim zrobiła przerwę.',
            lt: 'Ji kelių valandų mokėsi, prieš padariusi pertrauką.',
            ar: 'كانت قد درست لعدة ساعات قبل أن تأخذ استراحة.',
            ua: 'Вона вчилася кілька годин, перш ніж зробила перерву.',
    ...
    },
    {
        ...
        textIndex: [],
        translations: {
            eng: 'We had traveled through all of Europe before the pandemic started.',
            pl: 'Podróżowaliśmy przez całą Europę przed rozpoczęciem pandemii.',
            lt: 'Mes buvome keliavę per visą Europą prieš prasidedant pandemijai.',
            ar: 'كنا قد سافرنا عبر كل أوروبا قبل أن تبدأ الجائحة.',
            ua: 'Ми подорожували всією Європою до початку пандемії.',
    ...
    },
    {
        ...
        textIndex: [],
        translations: {
            eng: 'He had completed his project before the deadline.',
            pl: 'Zakończył swój projekt przed terminem.',
            lt: 'Jis buvo užbaigęs savo projektą prieš terminą.',
            ar: 'كان قد أكمل مشروعه قبل الموعد النهائي.',
            ua: 'Він завершив свій проєкт до кінцевого терміну.',
    ...
    },
    {
        ...
        textIndex: [],
        translations: {
            eng: 'They had watched the movie several times before they decided to read the book.',
            pl: 'Oglądali film kilka razy, zanim zdecydowali się przeczytać książkę.',
            ar: 'كانوا قد شاهدوا الفيلم عدة مرات قبل أن يقرروا قراءة الكتاب.',
            ger: 'Sie hatten den Film mehrmals gesehen, bevor sie sich entschieden, das Buch zu lesen.',
            lt: 'Jie kelis kartus žiūrėjo filmą, prieš nuspręsdami perskaityti knygą.',
    ...
    },
    {
        ...
        textIndex: [],
        translations: {
            eng: 'I am now developing a new method for environmentally friendly energy production.',
            pl: 'Obecnie opracowuję nową metodę produkcji energii przyjaznej dla środowiska.',
            lt: 'Šiuo metu kuriu naują aplinkai draugiškos energijos gamybos metodą.',
            ar: 'أنا الآن أطور طريقة جديدة لإنتاج الطاقة الصديقة للبيئة.',
            ua: 'Зараз я розробляю новий метод екологічно чистого виробництва енергії.',
    ...
    },
    {
        ...
        textIndex: [],
        translations: {
            eng: 'She is analyzing data from the latest research study.',
            pl: 'Analizuje dane z najnowszego badania naukowego.',
            lt: 'Ji analizuoja duomenis iš naujausio mokslinio tyrimo.',
            ar: 'هي تحلل البيانات من أحدث دراسة بحثية.',
            ua: 'Вона аналізує дані з останнього дослідження.',
    ...
    },
    {
        ...
        textIndex: [],
        translations: {
            eng: 'We often discuss the implications of artificial intelligence for society.',
            pl: 'Często dyskutujemy o implikacjach sztucznej inteligencji dla społeczeństwa.',
            lt: 'Mes dažnai aptariame dirbtinio intelekto poveikį visuomenei.',
            ar: 'نحن غالبًا ما نناقش تداعيات الذكاء الاصطناعي على المجتمع.',
            ua: 'Ми часто обговорюємо наслідки штучного інтелекту для суспільства.',
    ...
    },
    {
        ...
        textIndex: [],
        translations: {
            eng: 'He continuously improves his language skills by practicing daily.',
            pl: 'On ciągle poprawia swoje umiejętności językowe, codziennie ćwicząc.',
            lt: 'Jis nuolat tobulina savo kalbos įgūdžius kasdien praktikuodamasis.',
            ar: 'يحسن مهاراته اللغوية بشكل مستمر من خلال الممارسة اليومية.',
            ua: 'Він постійно покращує свої мовні навички, практикуючись щодня.',
    ...
    },
    {
        ...
        textIndex: [],
        translations: {
            eng: 'They actively participate in debates on global environmental issues.',
            pl: 'Aktywnie uczestniczą w debatach na temat globalnych problemów środowiskowych.',
            lt: 'Jie aktyviai dalyvauja diskusijose apie pasaulines aplinkos problemas.',
            ar: 'يشاركون بنشاط في المناقشات حول القضايا البيئية العالمية.',
            ua: 'Вони активно беруть участь у дебатах щодо глобальних екологічних проблем.',
    ...
    },
    {
        ...
        textIndex: [],
        translations: {
            eng: 'I would have traveled around the world if I had more free time.',
            pl: 'Podróżowałbym po świecie, gdybym miał więcej wolnego czasu.',
            lt: 'Keliaučiau po pasaulį, jei turėčiau daugiau laisvo laiko.',
            ar: 'كنت سأسافر حول العالم لو كان لدي المزيد من الوقت الحر.',
            ua: 'Я б подорожував навколо світу, якби мав більше вільного часу.',
    ...
    },
    {
        ...
        textIndex: [],
        translations: {
            eng: 'She would have studied medicine if she had not chosen engineering.',
            pl: 'Studiowałaby medycynę, gdyby nie wybrała inżynierii.',
            lt: 'Ji būtų studijavusi mediciną, jei nebūtų pasirinkusi inžinerijos.',
            ar: 'كانت ستدرس الطب لو لم تختر الهندسة.',
            ua: 'Вона б вивчала медицину, якби не обрала інженерію.',
    ...
    },
    {
        ...
        textIndex: [],
        translations: {
            eng: 'We could have solved the problem if we had had more information.',
            pl: 'Moglibyśmy rozwiązać problem, gdybyśmy mieli więcej informacji.',
            lt: 'Mes galėjome išspręsti problemą, jei būtume turėję daugiau informacijos.',
            ar: 'كنا لنحل المشكلة لو كان لدينا مزيد من المعلومات.',
            ua: 'Ми могли б вирішити проблему, якби мали більше інформації.',
    ...
    },
    {
        ...
        textIndex: [],
        translations: {
            eng: 'He would have written a book about his experiences if he had the time for it.',
            pl: 'Napisałby książkę o swoich doświadczeniach, gdyby miał na to czas.',
            lt: 'Jis būtų parašęs knygą apie savo patirtis, jei būtų turėjęs tam laiko.',
            ar: 'كان سيكتب كتابًا عن تجاربه لو كان لديه الوقت لذلك.',
            ua: 'Він би написав книгу про свої досвіди, якби мав на це час.',
    ...
    },
    {
        ...
        textIndex: [],
        translations: {
            eng: 'They would have invested in the project if they had seen its potential earlier.',
            pl: 'Zainwestowaliby w projekt, gdyby wcześniej dostrzegli jego potencjał.',
            lt: 'Jie būtų investavę į projektą, jei būtų anksčiau matę jo potencialą.',
            ar: 'كانوا سيستثمرون في المشروع لو رأوا إمكانياته مبكرًا.',
            ua: 'Вони б інвестували в проєкт, якби раніше побачили його потенціал.',
    ...
    },
    {
        ...
        textIndex: [],
        translations: {
            eng: 'A new theory has been proposed by scientists in quantum physics.',
            pl: 'Naukowcy z dziedziny fizyki kwantowej zaproponowali nową teorię.',
            lt: 'Kvantinės fizikos mokslininkai pasiūlė naują teoriją.',
            ar: 'تم اقتراح نظرية جديدة من قبل علماء فيزياء الكم.',
            ua: 'Науковцями з квантової фізики було запропоновано нову теорію.',
    ...
    },
    {
        ...
        textIndex: [],
        translations: {
            eng: 'The book was written by a Nobel Prize-winning author.',
            pl: 'Książka została napisana przez autora nagrodzonego Nagrodą Nobla.',
            lt: 'Knygą parašė Nobelio premijos laureatas autorius.',
            ar: 'تم كتابة الكتاب من قبل مؤلف فائز بجائزة نوبل.',
            ua: 'Книгу написав автор, який отримав Нобелівську премію.',
    ...
    },
    {
        ...
        textIndex: [],
        translations: {
            eng: 'Our ideas were carefully considered during the meeting.',
            pl: 'Nasze pomysły zostały starannie rozważone podczas spotkania.',
            lt: 'Mūsų idėjos buvo atidžiai apsvarstytos susitikimo metu.',
            ar: 'تم النظر بعناية في أفكارنا خلال الاجتماع.',
            ua: 'На наші ідеї уважно звернули увагу під час зустрічі.',
    ...
    },
    {
        ...
        textIndex: [],
        translations: {
            eng: 'The research results have been published in a reputable scientific journal.',
            pl: 'Wyniki badań zostały opublikowane w renomowanym czasopiśmie naukowym.',
            lt: 'Tyrimo rezultatai paskelbti prestižiniame moksliniame žurnale.',
            ar: 'تم نشر نتائج البحث في مجلة علمية مرموقة.',
            ua: 'Результати дослідження були опубліковані в авторитетному науковому журналі.',
    ...
    },
    {
        ...
        textIndex: [],
        translations: {
            eng: 'The new legislation was introduced to protect endangered species.',
            pl: 'Nowe przepisy zostały wprowadzone w celu ochrony zagrożonych gatunków.',
            lt: 'Naujieji įstatymai buvo įvesti siekiant apsaugoti nykstančias rūšis.',
            ar: 'تم تقديم التشريعات الجديدة لحماية الأنواع المهددة بالانقراض.',
            ua: 'Нове законодавство було введено для захисту зникаючих видів.',
    ...
    },
    {
        ...
        textIndex: [],
        translations: {
            eng: 'I had already considered the consequences before making a decision.',
            pl: 'Już wcześniej rozważyłem konsekwencje przed podjęciem decyzji.',
            lt: 'Aš jau buvau apsvarstęs pasekmes prieš priimant sprendimą.',
            ar: 'كنت قد فكرت بالعواقب قبل اتخاذ قرار.',
            ua: 'Я вже розглянув наслідки перед тим, як прийняти рішення.',
    ...
    },
    {
        ...
        textIndex: [],
        translations: {
            eng: 'She is preparing for a presentation that will define her academic career.',
            pl: 'Przygotowuje się do prezentacji, która zdefiniuje jej karierę akademicką.',
            lt: 'Ji ruošiasi pristatymui, kuris apibrėš jos akademinę karjerą.',
            ar: 'هي تستعد لعرض سيحدد مسيرتها الأكاديمية.',
            ua: "Вона готується до презентації, яка визначить її академічну кар'єру.",
    ...
    },
    {
        ...
        textIndex: [],
        translations: {
            eng: 'We would have participated in the conference if it had been practically possible.',
            pl: 'Wzięlibyśmy udział w konferencji, gdyby to było praktycznie możliwe.',
            lt: 'Mes būtume dalyvavę konferencijoje, jei tai būtų buvę praktiškai įmanoma.',
            ar: 'لكنا قد شاركنا في المؤتمر لو كان ذلك ممكنًا عمليًا.',
            ua: 'Ми б взяли участь у конференції, якби це було практично можливо.',
    ...
    },
    {
        ...
        textIndex: [],
        translations: {
            eng: 'A comprehensive study had been conducted before the measures were implemented.',
            pl: 'Przeprowadzono obszerne badanie przed wprowadzeniem środków.',
            lt: 'Prieš įgyvendinant priemones, buvo atlikta išsami tyrimas.',
            ar: 'تم إجراء دراسة شاملة قبل تنفيذ التدابير.',
            ua: 'Перед впровадженням заходів було проведено всеосяжне дослідження.',
    ...
    },
    {
        ...
        textIndex: [],
        translations: {
            eng: 'He strives to understand the complexity of human psychology through his studies.',
            pl: 'Dąży do zrozumienia złożoności psychologii ludzkiej poprzez swoje studia.',
            lt: 'Jis siekia suprasti žmogaus psichologijos sudėtingumą per savo studijas.',
            ar: 'يسعى لفهم تعقيدات علم النفس البشري من خلال دراسته.',
            ua: 'Він прагне зрозуміти складність людської психології через своє навчання.',
    ...
    },
    {
        ...
        textIndex: [],
        translations: {
            eng: 'The proposal would have been accepted if it had been presented differently.',
            pl: 'Propozycja zostałaby przyjęta, gdyby została przedstawiona inaczej.',
            lt: 'Pasiūlymas būtų priimtas, jei būtų buvęs pateiktas kitaip.',
            ar: 'كان سيتم قبول الاقتراح لو تم تقديمه بطريقة مختلفة.',
            ua: 'Пропозицію було б прийнято, якби вона була представлена по-іншому.',
    ...
    },
    {
        ...
        textIndex: [],
        translations: {
            eng: "I analyze how digital media affects young people's self-perception.",
            pl: 'Analizuję, jak media cyfrowe wpływają na postrzeganie siebie przez młodych ludzi.',
            lt: 'Analizuoju, kaip skaitmeninės medijos veikia jaunimo savęs suvokimą.',
            ar: 'أنا أحلل كيف تؤثر الوسائط الرقمية على تصور الشباب لذاتهم.',
            ua: 'Я аналізую, як цифрові медіа впливають на самосприйняття молоді.',
    ...
    },
    {
        ...
        textIndex: [],
        translations: {
            eng: 'A revolutionary invention has been developed by a team of young engineers.',
            pl: 'Rewolucyjny wynalazek został opracowany przez zespół młodych inżynierów.',
            lt: 'Revoliucinį išradimą sukūrė jaunų inžinierių komanda.',
            ar: 'تم تطوير اختراع ثوري من قبل فريق من المهندسين الشباب.',
            ua: 'Революційний винахід було розроблено командою молодих інженерів.',
    ...
    },
    {
        ...
        textIndex: [],
        translations: {
            eng: 'We had explored all the alternatives before we decided on the current plan.',
            pl: 'Zbadaliśmy wszystkie alternatywy, zanim zdecydowaliśmy się na obecny plan.',
            lt: 'Mes ištyrėme visas alternatyvas, prieš nuspręsdami dėl dabartinio plano.',
            ar: 'كنا قد استكشفنا جميع البدائل قبل أن نقرر على الخطة الحالية.',
            ua: 'Ми розглянули всі альтернативи, перш ніж вирішити на користь поточного плану.',
    ...
    },
    {
        ...
        textIndex: [],
        translations: {
            eng: 'She would have traveled to Mars if the technology had allowed it.',
            pl: 'Podróżowałaby na Marsa, gdyby technologia na to pozwoliła.',
            lt: 'Ji būtų keliavusi į Marsą, jei technologija būtų leidusi.',
            ar: 'لكانت قد سافرت إلى المريخ لو سمحت التكنولوجيا بذلك.',
            ua: 'Вона б подорожувала на Марс, якби технології це дозволяли.',
    ...
    },
    {
        ...
        textIndex: [],
        translations: {
            eng: 'The dialogue between the parties was facilitated by an experienced mediator.',
            pl: 'Dialog między stronami został ułatwiony przez doświadczonego mediatora.',
            lt: 'Dialogas tarp šalių buvo palengvintas patyrusio mediatoriaus.',
            ar: 'تم تيسير الحوار بين الأطراف من قبل وسيط متمرس.',
            ua: 'Діалог між сторонами було полегшено досвідченим медіатором.',
    ...
    },
    {
        ...
        textIndex: [],
        translations: {
            eng: 'I had completed advanced training in conflict resolution before I started in this position.',
            pl: 'Zakończyłem zaawansowane szkolenie z rozwiązywania konfliktów, zanim zacząłem pracę na tym stanowisku.',
            lt: 'Prieš pradėdamas dirbti šioje pozicijoje, aš baigiau pažangų konfliktų sprendimo mokymą.',
            ar: 'كنت قد أكملت تدريباً متقدماً في حل النزاعات قبل أن أبدأ في هذا المنصب.',
            ua: 'Я завершив передове навчання з вирішення конфліктів, перш ніж почати працювати на цій посаді.',
    ...
    },
    {
        ...
        textIndex: [],
        translations: {
            eng: "He reflects on how decisions made at a young age affect one's future career.",
            pl: 'Zastanawia się, jak decyzje podjęte w młodym wieku wpływają na przyszłą karierę.',
            lt: 'Jis svarsto, kaip sprendimai, priimti jauname amžiuje, veikia žmogaus būsimą karjerą.',
            ar: 'يتأمل في كيفية تأثير القرارات المتخذة في سن مبكرة على مسيرة المرء المهنية في المستقبل.',
            ua: "Він роздумує над тим, як рішення, ухвалені в молодому віці, впливають на майбутню кар'єру.",
    ...
    },
    {
        ...
        textIndex: [],
        translations: {
            eng: 'Innovations in sustainable technology are continually introduced by startups.',
            pl: 'Innowacje w technologii zrównoważonego rozwoju są ciągle wprowadzane przez start-upy.',
            lt: 'Inovacijos tvariosios technologijos srityje nuolat pristatomos startuolių.',
            ar: 'يتم تقديم الابتكارات في التكنولوجيا المستدامة بشكل مستمر من قبل الشركات الناشئة.',
            ua: 'Інновації у сфері сталої технології постійно впроваджуються стартапами.',
    ...
    },
    {
        ...
        textIndex: [],
        translations: {
            eng: "We could have improved the system's efficiency if we had access to newer technology.",
            pl: 'Moglibyśmy poprawić efektywność systemu, gdybyśmy mieli dostęp do nowszej technologii.',
            lt: 'Mes galėtume pagerinti sistemos efektyvumą, jei turėtume prieigą prie naujesnės technologijos.',
            ar: 'كنا لنحسن كفاءة النظام لو كان لدينا إمكانية الوصول إلى تكنولوجيا أحدث.',
            ua: 'Ми могли б покращити ефективність системи, якби мали доступ до новітніх технологій.',
    ...
    },
    {
        ...
        textIndex: [],
        translations: {
            eng: 'The critical evaluation of literature is essential for a deeper understanding of a subject.',
            pl: 'Krytyczna ocena literatury jest niezbędna do głębszego zrozumienia tematu.',
            lt: 'Literatūros kritinis vertinimas yra būtinas gilesniam temos supratimui.',
            ar: 'تقييم الأدب النقدي أساسي لفهم أعمق لموضوع ما.',
            ua: 'Критичне оцінювання літератури є важливим для глибшого розуміння предмета.',
    ...
    },
    {
        ...
        textIndex: [],
        translations: {
            eng: 'She had acquired an impressive amount of knowledge before she participated in the debate.',
            pl: 'Nabyła imponującą ilość wiedzy, zanim wzięła udział w debacie.',
            lt: 'Ji buvo įgijusi įspūdingą žinių kiekį prieš dalyvaudama diskusijoje.',
            ar: 'كانت قد اكتسبت كمية مثيرة للإعجاب من المعرفة قبل أن تشارك في النقاش.',
            ua: 'Вона набула вражаючу кількість знань, перш ніж взяла участь у дебатах.',
    ...
    },
    {
        ...
        textIndex: [],
        translations: {
            eng: 'We would have explored more cultures if travel restrictions had not been imposed.',
            pl: 'Zbadalibyśmy więcej kultur, gdyby nie wprowadzono ograniczeń w podróżowaniu.',
            lt: 'Mes būtume tyrinėję daugiau kultūrų, jei nebūtų buvę įvesti kelionių apribojimai.',
            ar: 'لكنا استكشفنا المزيد من الثقافات لولا فرض قيود السفر.',
            ua: 'Ми б дослідили більше культур, якби не було введено обмеження на подорожі.',
    ...
    },
    {
        ...
        textIndex: [],
        translations: {
            eng: 'Technological advances in renewable energy are regularly reported in scientific journals.',
            pl: 'Postępy technologiczne w dziedzinie energii odnawialnej są regularnie raportowane w czasopismach naukowych.',
            lt: 'Technologinės pažangos atsinaujinančiosios energijos srityje reguliariai skelbiamos moksliniuose žurnaluose.',
            ar: 'يتم تقديم التقدم التكنولوجي في مجال الطاقة المتجددة بانتظام في المجلات العلمية.',
            ua: 'Технологічні досягнення у сфері відновлюваної енергії регулярно повідомляються в наукових журналах.',
    ...
    },
    {
        ...
        textIndex: [],
        translations: {
            eng: 'The research data had been collected over a decade before the analysis began.',
            pl: 'Dane badawcze zostały zebrane przez dekadę przed rozpoczęciem analizy.',
            lt: 'Tyrimo duomenys buvo surinkti per dešimtmetį prieš pradedant analizę.',
            ar: 'تم جمع بيانات البحث على مدار عقد من الزمان قبل بدء التحليل.',
            ua: 'Дані дослідження були зібрані протягом десятиліття перед початком аналізу.',
    ...
    },
    {
        ...
        textIndex: [],
        translations: {
            eng: 'She discusses the possibilities of integrating virtual reality into the education sector.',
            pl: 'Dyskutuje o możliwościach integracji wirtualnej rzeczywistości w sektorze edukacyjnym.',
            lt: 'Ji aptaria virtualios realybės integravimo į švietimo sektorių galimybes.',
            ar: 'تناقش إمكانيات دمج الواقع الافتراضي في قطاع التعليم.',
            ua: 'Вона обговорює можливості інтеграції віртуальної реальності в освітній сектор.',
    ...
    },
    {
        ...
        textIndex: [],
        translations: {
            eng: 'A better understanding of genetics could have revolutionized medicine if ethics had not limited research.',
            pl: 'Lepsze zrozumienie genetyki mogłoby zrewolucjonizować medycynę, gdyby etyka nie ograniczała badań.',
            lt: 'Geresnis genetikos supratimas galėjo revoliucionizuoti mediciną, jei etika nebūtų ribojusi tyrimų.',
            ar: 'لكان فهم أفضل للوراثة قد ثور على الطب لولا أن الأخلاق قيدت البحث.',
            ua: 'Краще розуміння генетики могло б революціонізувати медицину, якби етика не обмежувала дослідження.',
    ...
    },
    {
        ...
        textIndex: [],
        translations: {
            eng: 'This documentary was produced to raise awareness about climate change.',
            pl: 'Ten dokument został wyprodukowany, aby zwiększyć świadomość na temat zmian klimatycznych.',
            lt: 'Šis dokumentinis filmas buvo sukurtas siekiant padidinti sąmoningumą apie klimato kaitą.',
            ar: 'تم إنتاج هذا الوثائقي لزيادة الوعي بتغير المناخ.',
            ua: 'Цей документальний фільм був створений для підвищення обізнаності про зміну клімату.',
    ...
    },
    {
        ...
        textIndex: [],
        translations: {
            eng: 'I had achieved a significant understanding of quantum mechanics before I completed my studies.',
            pl: 'Zdobyłem znaczące zrozumienie mechaniki kwantowej przed zakończeniem studiów.',
            ar: 'كنت قد حققت فهمًا كبيرًا لميكانيكا الكم قبل أن أنهي دراستي.',
            ger: 'Ich hatte ein bedeutendes Verständnis der Quantenmechanik erreicht, bevor ich mein Studium beendete.',
            lt: 'Prieš baigdamas studijas, aš buvau pasiekęs reikšmingą supratimą apie kvantinę mechaniką.',
      ...
      },
      {
        ...
        textIndex: [],
        translations: {
            eng: 'He would have changed his career path if he had known about all the alternatives earlier.',
            pl: 'Zmieniłby ścieżkę kariery, gdyby wcześniej znał wszystkie alternatywy.',
            ar: 'لكان قد غير مساره المهني لو عرف عن جميع البدائل مسبقًا.',
            ger: 'Er hätte seinen Karriereweg geändert, wenn er früher von allen Alternativen gewusst hätte.',
            lt: 'Jis būtų pakeitęs karjeros kelią, jei būtų anksčiau žinojęs apie visas alternatyvas.',
      ...
      },
      {
        ...
        textIndex: [],
        translations: {
            eng: 'The debate on climate change is often influenced by political interests, as reported by scientists.',
            pl: 'Debata na temat zmian klimatycznych jest często wpływana przez interesy polityczne, jak donoszą naukowcy.',
            ar: 'النقاش حول تغير المناخ غالبًا ما يتأثر بالمصالح السياسية، كما ذكر العلماء.',
            ger: 'Die Debatte über den Klimawandel wird oft von politischen Interessen beeinflusst, wie Wissenschaftler berichtet haben.',
            lt: 'Diskusija apie klimato kaitą dažnai veikiama politinių interesų, kaip praneša mokslininkai.',
      ...
      },
      {
        ...
        textIndex: [],
        translations: {
            eng: 'Innovation in sustainable agriculture has been stimulated by global environmental challenges.',
            pl: 'Innowacje w zrównoważonym rolnictwie zostały stymulowane przez globalne wyzwania środowiskowe.',
            ar: 'تم تحفيز الابتكار في الزراعة المستدامة بواسطة التحديات البيئية العالمية.',
            ger: 'Innovationen in der nachhaltigen Landwirtschaft wurden durch globale Umweltherausforderungen angeregt.',
            lt: 'Inovacijos tvarioje žemės ūkyje buvo skatinamos pasauliniais aplinkosaugos iššūkiais.',
      ...
      },
      {
        ...
        textIndex: [],
        translations: {
            eng: 'We had considered all the risks before we invested in the new market.',
            pl: 'Rozważyliśmy wszystkie ryzyka, zanim zainwestowaliśmy w nowy rynek.',
            ar: 'كنا قد وضعنا في اعتبارنا جميع المخاطر قبل أن نستثمر في السوق الجديد.',
            ger: 'Wir hatten alle Risiken bedacht, bevor wir in den neuen Markt investiert haben.',
            lt: 'Mes buvome apsvarstę visus rizikos veiksnius prieš investuodami į naują rinką.',
