...
// import data for exercises from local files
...
const dataForMarkers = {
  ...
  class: 'class0' // change class
}

let option1 = [type1data, ]; // create different sets with data from local files. example => [type1data, type1data, type2data, type5data, type6data, type7data, type8data];
let option2 = [type1data, ]; // create different sets with data from local files. example => [type1data, type1data, type4data, type5data];
let option3 = [type1data, ]; // create different sets with data from local files. example => [type1data, type1data, type3data];

const links1 = []; // create links corelated to options above, first link is a opening link . example => ['Exc1x2x1', 'Type1', 'Type2', 'Type5', 'Type6', 'Type7', 'Type8'];
const links2 = []; // create links corelated to options above, first link is a opening link . example => ['Exc1x2x1', 'Type1', 'Type4', 'Type5'];
const links3 = []; // create links corelated to options above, first link is a opening link . example => ['Exc1x2x1', 'Type1', 'Type3'];
...
const Exc1x2x1 = ({route}) => {
  ...
  useEffect(() => {
    ...
    option1 = [type1dataNew, ];
    option2 = [type1dataNew, ];
    option3 = [type1dataNew, ];
...
export default Exc1x2x1  // change name here
