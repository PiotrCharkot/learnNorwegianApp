...
let option1 = [type8data, ];
let option2 = [type8data, ];
let option3 = [type8data, ];

const links1 = ['Exc1x9x1', ];
const links2 = ['Exc1x9x1', ];
const links3 = ['Exc1x9x1', ];
...
const Exc1x9x1 = ({ route }) => {
    ...
    useEffect(() => {
      ...
      option1 = [type8dataNew, ];
      option2 = [type8dataNew, ];
      option3 = [type8dataNew, ];
